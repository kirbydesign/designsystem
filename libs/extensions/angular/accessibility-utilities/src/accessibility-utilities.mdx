...
<Meta title='Pipes/Localization/Formatting1' /># Formatting Pipes The following pipes are utilities
that can be used to format data for display purposes. They are particularly useful in localization,
where data such as numbers, dates, and currencies need to be presented in a format that is familiar
to the user based on their locale. The pipes are also useful for ensuring a common presentation of
the supported data types across one or more applications.
...
If you need the formatted value in your component code instead of in the template, you can import
