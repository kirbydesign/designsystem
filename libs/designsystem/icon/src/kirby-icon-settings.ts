...
export const kirbyIconSettings: IconSettings = {
  icons: sortIconsByName([
    ...
    { name: 'note', svg: 'note.svg' },
    { name: 'note-create', svg: 'note-create.svg' },
    ...
    { name: 'person-blocked', svg: 'person-blocked.svg' },
    { name: 'person-check', svg: 'person-check.svg' },
    { name: 'person-close', svg: 'person-close.svg' },
    { name: 'person-power', svg: 'person-power.svg' },
    { name: 'person-cloud', svg: 'person-cloud.svg' },
    { name: 'person-warning', svg: 'person-warning.svg' },
    { name: 'phone-device-pin', svg: 'phone-device-pin.svg' },
    { name: 'qr', svg: 'QR.svg' },
