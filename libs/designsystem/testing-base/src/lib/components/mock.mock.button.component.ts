...
import { MockButtonComponent } from '@kirbydesign/designsystem';
...
@Component({
  ...
  providers: [
    {
      provide: MockButtonComponent,
      useExisting: forwardRef(() => MockMockButtonComponent),
    },
  ],
})
export class MockMockButtonComponent {
