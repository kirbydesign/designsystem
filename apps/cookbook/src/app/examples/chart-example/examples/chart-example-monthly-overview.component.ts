...
const config = {
  ...
  template: `
  <kirby-card>
  <kirby-card-header [title]="'Custom chart - Monthly overview'"></kirby-card-header>
  <kirby-chart [height]="height" [type]="'custom'" [options]="monthlyOverviewOptions"> </kirby-chart>
  </kirby-card>
  `,
  codeSnippet: `
