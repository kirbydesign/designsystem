...
@Component({
  selector: 'cookbook-chart-deprecated-showcase',
  templateUrl: './chart-deprecated-showcase.component.html',
  styleUrls: ['./chart-deprecated-showcase.component.scss'],
})
export class ChartDeprecatedShowcaseComponent {
