...
import { StockChartExampleSimpleComponent } from '../../examples/stock-chart-example/example/stock-chart-example-simple.component';
import { StockChartExampleComparisonComponent } from '../../examples/stock-chart-example/example/stock-chart-example-comparison.component';
...
@Component({
  ...
  imports: [
    ...
    StockChartExampleSimpleComponent,
