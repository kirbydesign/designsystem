...
import { PageFixedFooterTabsExampleComponent } from '~/app/examples/page-example/fixed-footer-tabs/fixed-footer-tabs-example.component';
...
export class PageShowcaseComponent {
  ...
  fixedFooterTabsExampleHtml: string = PageFixedFooterTabsExampleComponent.template;
