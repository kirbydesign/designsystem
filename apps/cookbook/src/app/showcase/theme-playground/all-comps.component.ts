...
@Component({
  ...
  template: `
    <button kirby-button size="lg" id="open-modal">Show modal</button>

    <kirby-modal flavor="modal" trigger="open-modal">
      <ng-template>
        ...
        <kirby-page-progress>
          ...
          >
            <kirby-icon name="health"></kirby-icon>
          </kirby-progress-circle>
        </kirby-page-progress>
        <p>Lorem ipsum.</p>
    ...
    <div class="columns">
      <div class="column">
        <kirby-loading-overlay [isLoading]="true" [hideContent]="true" [showBackdrop]="false">
          <kirby-avatar
      ...
      <div class="column">
        <kirby-loading-overlay [isLoading]="true" [hideContent]="false" [showBackdrop]="true">
          <div style="width: 100%">
            <kirby-avatar
    ...
    <div class="columns">
      <div class="column">
        ...
        <button kirby-button [noDecoration]="true">
          <kirby-icon name="kirby"></kirby-icon>
        </button>
      </div>
      <div class="column">
    ...
    <kirby-item>
      ...
      <kirby-label>
        ...
        <p class="kirby-item-subtitle">
          Subtitle will wrap if necessary in two lines and truncate with ellipsis if it overflows.
        </p>
        <p class="kirby-item-detail kirby-item-wrap">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut non neque vitae felis
          ultricies imperdiet in ut orci. Ut non neque vitae felis ultricies imperdiet in ut orci.
        </p>
      </kirby-label>
    </kirby-item>
    <kirby-item>
    ...
    <kirby-item [selectable]="true" [disabled]="true">
