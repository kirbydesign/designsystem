import{$b as fo,$c as Wt,$d as _i,Aa as We,Ac as _o,Ad as Le,Ae as $o,Ba as P,Bc as ci,Bd as ui,C as S,Cc as wo,Cd as Xe,D as M,Da as b,Dc as Nt,Dd as gi,De as jo,Ea as y,Ec as f,Ed as V,Ee as Yo,Fa as ro,Fc as He,Fd as et,Fe as Ae,Ga as ao,Gc as ce,Gd as F,Ha as It,Hc as mi,Ia as Ft,Ic as T,J as pe,Ja as Lt,Jc as Fe,Jd as yi,Ka as X,Kc as Kt,Kd as ki,L as Xt,Lc as di,Ma as R,Mc as pi,N as Xi,Na as lo,Nc as oe,Nd as zo,O as L,Oa as l,Ob as At,Od as ze,Pa as k,Pb as Bt,Pc as So,Pd as Gt,Qa as _,Qb as be,Qc as qt,Qd as ue,Ra as so,Rb as Ce,Rd as tt,S as Y,Sb as ii,Sc as z,Sd as fi,Ta as Oe,Tb as Qt,Td as Ao,Ua as W,Ub as oi,Ud as Bo,V as eo,Va as Ie,Vb as ni,Vd as J,Wa as De,Wb as ve,Wd as No,X as c,Xa as Bi,Xb as xe,Xc as Ze,Xd as hi,Yb as _e,Yc as Ht,Yd as Ci,Za as D,Zc as Mo,Zd as vi,_a as co,_d as xi,ab as Z,ac as ri,ad as N,ae as Ko,b as Zt,ba as v,bb as re,bc as qe,bd as To,be as qo,cb as mo,cc as ye,cd as Vt,ce as $t,da as d,db as po,dc as we,dd as Eo,de as ee,e as Yi,eb as ft,ed as H,ee as wi,fc as ai,fe as $,ga as E,gd as Se,ge as Ho,h as Ui,ha as x,hd as Me,he as Wo,ib as bo,ic as li,ie as jt,j as Ai,jd as G,k as Qi,ka as Ne,kd as ht,la as O,ld as Po,ma as I,md as Do,me as Ee,na as ei,nb as uo,nd as Oo,ne as le,oa as to,ob as zt,od as B,oe as Pe,pa as K,pc as Ke,pd as ke,pe as it,qa as q,qb as go,qc as ho,qd as ae,qe as ot,ra as m,rb as Qe,rc as si,rd as Io,re as Vo,s as Ji,sa as o,sb as ti,sc as Ni,sd as Te,se as Si,t as Zi,ta as n,tb as yo,tc as U,td as h,te as Ro,ua as p,ub as Je,uc as Co,ud as A,ue as Go,va as se,vb as ko,vd as Fo,ve as nt,wa as ne,wc as vo,wd as Q,xa as io,xd as Rt,ya as oo,yc as xo,yd as Lo,ye as me,za as no,zc as w,zd as bi,ze as Mi}from"./chunk-6RNHP3IM.js";var _r={selector:"cookbook-item-example-sizes",template:`<kirby-item>
...
`),n())},dependencies:[ue],styles:["[_nghost-%COMP%]{display:flex!important;align-items:center}kirby-progress-circle[_ngcontent-%COMP%]{margin-right:var(--kirby-spacing-m)}kirby-progress-circle[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{display:flex;justify-content:center;align-items:center;flex-direction:column;width:100%;height:100%;margin:0;text-align:center;font-size:var(--kirby-font-size-s);line-height:var(--kirby-font-size-n)}kirby-progress-circle[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]   em[_ngcontent-%COMP%]{font-size:var(--kirby-font-size-xxs)}"]});let i=e;return i})();var Mm={selector:"cookbook-progress-circle-example-content-avatar",template:`<kirby-progress-circle aria-label="Your investment savings" value="25" themeColor="danger" size="sm">
  <kirby-avatar themeColor="white">
    <kirby-icon name="kirby"></kirby-icon>
  </kirby-avatar>
</kirby-progress-circle>
...
}`]},FM=(()=>{let e=class e{constructor(){this.template=zi.template,this.styles=zi.styles.join(`
...
`)}onTitleClick(r){let t={message:"Title clicked...",messageType:"success",durationInMs:1500};this.toastController.showToast(t)}};e.\u0275fac=function(t){return new(t||e)(v(z))},e.\u0275cmp=d({type:e,selectors:[["cookbook-header-example-combined"]],decls:8,vars:1,consts:[["value","12.345,67","valueUnit","USD","subtitle1","Subtitle one","subtitle2","Subtitle two",3,"titleClick","title"],["name","arrow-down",4,"kirbyHeaderTitleActionIcon"],[4,"kirbyHeaderActions"],["size","lg"],["name","kirby"],["themeColor","warning"],["class","custom-section",4,"kirbyHeaderCustomSection"],["name","arrow-down"],["kirby-button","","attentionLevel","3"],[1,"custom-section"],["size","sm","themeColor","success"]],template:function(t,a){t&1&&(o(0,"kirby-header",0),b("titleClick",function(C){return a.onTitleClick(C)}),x(1,Ed,1,0,"kirby-icon",1)(2,Pd,8,0,"kirby-action-group",2),o(3,"kirby-avatar",3),p(4,"kirby-icon",4),n(),o(5,"kirby-flag",5),l(6,"Warning"),n(),x(7,Dd,3,0,"div",6),n()),t&2&&m("title","Title")},dependencies:[J,w,Gt,f,G,Le,le,fi,tt,Ao],styles:[".custom-section[_ngcontent-%COMP%]{display:flex;align-items:center;gap:8px;font-size:12px;color:var(--kirby-text-color-semi-dark)}"]});let i=e;return i})();function Od(i,e){i&1&&p(0,"kirby-icon",4)}var Id={template:`<kirby-page defaultBackHref="/">
  ...
  // Do something...
}`,gt.\u0275fac=function(s){return new(s||gt)(v(z))},gt.\u0275cmp=d({type:gt,selectors:[["ng-component"]],features:[E],decls:5,vars:2,consts:[["defaultBackHref","/"],["value","12345,67","valueUnit","USD","subtitle1","Subtitle one","subtitle2","Subtitle two",3,"titleClick","title"],["name","arrow-down",4,"kirbyHeaderTitleActionIcon"],[3,"innerHTML"],["name","arrow-down"]],template:function(s,r){s&1&&(o(0,"kirby-page",0)(1,"kirby-header",1),b("titleClick",function(a){return r.onTitleClick(a)}),x(2,Od,1,0,"kirby-icon",2),n(),o(3,"kirby-page-content"),p(4,"div",3),n()()),s&2&&(c(),m("title","Interactive Title"),c(3),m("innerHTML",r.content,Y))},dependencies:[$,J,w,ee],encapsulation:2});var fr=gt;function Fd(i,e){if(i&1){let s=P();oo(0),o(1,"kirby-menu")(2,"button",4),p(3,"kirby-icon",5),o(4,"span"),l(5,"Action"),n()(),o(6,"kirby-item",6),b("click",function(){S(s);let t=y();return M(t.actionClicked("Primary Action 1"))}),l(7," Primary Action 1 "),n(),o(8,"kirby-item",6),b("click",function(){S(s);let t=y();return M(t.actionClicked("Primary Action 2"))}),l(9," Primary Action 2 "),n()(),o(10,"kirby-menu")(11,"kirby-item",6),b("click",function(){S(s);let t=y();return M(t.actionClicked("Secondary Action 1"))}),l(12," Secondary Action 1 "),n(),o(13,"kirby-item",6),b("click",function(){S(s);let t=y();return M(t.actionClicked("Secondary Action 2"))}),l(14," Secondary Action 2 "),n()(),no()}i&2&&(c(6),m("selectable",!0),c(2),m("selectable",!0),c(3),m("selectable",!0),c(2),m("selectable",!0))}var Ld={template:`<kirby-page defaultBackHref="/">
