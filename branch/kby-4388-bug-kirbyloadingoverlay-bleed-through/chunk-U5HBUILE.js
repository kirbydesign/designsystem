...
</kirby-loading-overlay>`},av=(()=>{let e=class e{constructor(r){this.cdr=r,this.template=Ws.template,this.isLoading=!1}showCardLoadingOverlay(){this.isLoading=!0,setTimeout(()=>{this.hideLoadingOverlay()},3e3)}hideLoadingOverlay(){this.isLoading=!1,this.cdr.detectChanges()}};e.\u0275fac=function(t){return new(t||e)(v(At))},e.\u0275cmp=d({type:e,selectors:[["cookbook-loading-overlay-example-card"]],decls:4,vars:3,consts:[[3,"hideContent","isLoading"],[3,"hasPadding"],["kirby-button","","attentionLevel","2","size","lg","expand","block",3,"click"]],template:function(t,a){t&1&&(o(0,"kirby-loading-overlay",0)(1,"kirby-card",1)(2,"button",2),u("click",function(){return a.showCardLoadingOverlay()}),l(3," Show wrapper loading overlay that hides card content "),n()()()),t&2&&(m("hideContent",!0)("isLoading",a.isLoading),c(),m("hasPadding",!0))},dependencies:[Kt,f,T],encapsulation:2});let i=e;return i})();var Vs={selector:"cookbook-loading-overlay-example-default",template:`<kirby-loading-overlay
  [isLoading]="isLoading"
