...
</kirby-loading-overlay>`},cv=(()=>{let e=class e extends Yt{constructor(r){super(r),this.template=Vs.template}};e.\u0275fac=function(t){return new(t||e)(v(At))},e.\u0275cmp=d({type:e,selectors:[["cookbook-loading-overlay-example-card"]],features:[E],decls:6,vars:4,consts:[[3,"hideContent","isLoading","showBackdrop"],[3,"hasPadding"],["kirby-button","","attentionLevel","2","size","lg","expand","block",3,"click"]],template:function(t,a){t&1&&(o(0,"kirby-loading-overlay",0)(1,"kirby-card",1)(2,"button",2),u("click",function(){return a.showWrapperLoadingOverlay(!0)}),l(3," Show wrapper loading overlay on card "),n(),o(4,"button",2),u("click",function(){return a.showWrapperLoadingOverlay(!1,!0)}),l(5," Show wrapper loading overlay that hides card "),n()()()),t&2&&(m("hideContent",a.hideContent)("isLoading",a.isLoading)("showBackdrop",a.showBackdrop),c(),m("hasPadding",!0))},dependencies:[Kt,f,T],encapsulation:2});let i=e;return i})();var Rs={selector:"cookbook-loading-overlay-example-default",template:`<kirby-loading-overlay
  [isLoading]="isLoading"
