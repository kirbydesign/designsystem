...
></kirby-dropdown>`},Xg=(()=>{let e=class e{constructor(){this.template=rl.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-dropdown-example-expand"]],decls:1,vars:2,consts:[["placeholder","Block level Dropdown","aria-label","Choose your favorite fruit","expand","block",3,"items"]],template:function(t,a){t&1&&p(0,"kirby-dropdown",0),t&2&&m("items",I(1,nl))},dependencies:[Q],encapsulation:2});let i=e;return i})();var al=()=>["Apple","Banana","Blackberry","Blueberry","Grapes"],bn={selector:"cookbook-dropdown-example-right-aligned",template:`<kirby-dropdown
...
didDismiss() {
  this.isOpen = false;
        ...
        <p>Alias aspernatur consequuntur debitis delectus ducimus, enim eveniet inventore laudantium libero molestiae
            ...
            nesciunt quas recusandae saepe soluta tempore velit, vitae! Aperiam distinctio exercitationem id incidunt
            ipsa repellendus similique sunt vero.</p>
        <p class="kirby-text-medium">THE END</p>`}};var In=()=>({fixed:!0});function Pc(i,e){i&1&&We(0)}function Dc(i,e){if(i&1&&(o(0,"div")(1,"span",9),v(2,Pc,1,0,"ng-container",10),n()()),i&2){y();let s=X(5);c(2),m("ngTemplateOutlet",s)}}function Oc(i,e){i&1&&(o(0,"div"),l(1," Custom subtitle with a long long long long name "),n())}function Ic(i,e){i&1&&We(0)}function Fc(i,e){if(i&1&&v(0,Ic,1,0,"ng-container",10),i&2){y();let s=X(5);m("ngTemplateOutlet",s)}}function Lc(i,e){i&1&&l(0," Custom Title with a very long name ")}function Ac(i,e){i&1&&l(0," Custom subtitle of custom title with a very long name ")}function zc(i,e){if(i&1){let s=O();o(0,"kirby-page-actions")(1,"button",11),u("click",function(){S(s);let t=y();return M(t.onMoreSelect())}),p(2,"kirby-icon",12),n()()}}function Bc(i,e){if(i&1){let s=O();o(0,"kirby-page-actions")(1,"button",13),u("click",function(){S(s);let t=y();return M(t.onCogSelect())}),p(2,"kirby-icon",14),n()()}}function Nc(i,e){if(i&1&&p(0,"div",15),i&2){let s=y();m("innerHTML",s.content,Y)}}function Kc(i,e){if(i&1){let s=O();o(0,"kirby-fab-sheet",16),p(1,"kirby-icon",17),o(2,"kirby-action-sheet",18),u("itemSelect",function(t){S(s);let a=y();return M(a.onItemSelect(t))}),n()()}if(i&2){let s=y();c(2),m("items",s.items)}}var qc={template:`<kirby-page defaultBackHref="/">
  ...
  <kirby-card>
    ...
    <kirby-item>
      ...
      kirby-card:first-of-type {
        margin-bottom: 24px;
      }`]},Tt=class Tt extends j{constructor(e){super(),this.route=e,this.showTabs=!0,this.showFooter=!0}ngOnInit(){this.title=this.route.snapshot.data.title}toggleTabs(){this.showTabs=!this.showTabs}toggleFooter(){this.showFooter=!this.showFooter}onCloseClick(){this.pageFooter.close(),this.showFooter=!1,this.showTabs=!0}};Tt.template=Nn.replace(/<kirby-page-content[^>]*>(.|\s)*?<\/kirby-page-content>/,"<kirby-page-content>...</kirby-page-content>"),Tt.\u0275fac=function(s){return new(s||Tt)(x(ii))},Tt.\u0275cmp=d({type:Tt,selectors:[["ng-component"]],viewQuery:function(s,r){if(s&1&&It(No,5),s&2){let t;Ft(t=Lt())&&(r.pageFooter=t.first)}},features:[E],decls:8,vars:6,consts:[["controls",""],[3,"title","tabBarBottomHidden"],[4,"ngTemplateOutlet"],[3,"innerHTML"],["kirby-button","","attentionLevel","2","aria-label","Close",1,"close-footer-btn",3,"click"],["name","close"],["slot","end",3,"click","checked"]],template:function(s,r){if(s&1&&(o(0,"kirby-page",1)(1,"kirby-page-content"),v(2,Zc,1,0,"ng-container",2),p(3,"div",3),v(4,Xc,1,0,"ng-container",2),n(),P(5,em,6,0,"kirby-page-footer"),n(),v(6,tm,9,2,"ng-template",null,0,ft)),s&2){let t=X(7);m("title",r.title)("tabBarBottomHidden",!r.showTabs),c(2),m("ngTemplateOutlet",t),c(),m("innerHTML",r.content,Y),c(),m("ngTemplateOutlet",t),c(),D(r.showFooter?5:-1)}},dependencies:[$,At,h,w,T,C,Ie,ee],styles:[".close-footer-btn[_ngcontent-%COMP%]{position:absolute;top:8px;right:16px;margin:0}kirby-card[_ngcontent-%COMP%]:first-of-type{margin-bottom:24px}"]});var Bn=Tt;var om=()=>({fixed:!0});function nm(i,e){if(i&1){let s=O();o(0,"kirby-page-actions")(1,"button",3),u("click",function(){S(s);let t=y();return M(t.onMoreSelect())}),p(2,"kirby-icon",4),n()()}}var rm={template:`<kirby-page>
...
`)}onTitleClick(r){let t={message:"Title clicked...",messageType:"success",durationInMs:1500};this.toastController.showToast(t)}};e.\u0275fac=function(t){return new(t||e)(x(A))},e.\u0275cmp=d({type:e,selectors:[["cookbook-header-example-combined"]],decls:8,vars:1,consts:[["value","12.345,67","valueUnit","USD","subtitle1","Subtitle one","subtitle2","Subtitle two",3,"titleClick","title"],["name","arrow-down",4,"kirbyHeaderTitleActionIcon"],[4,"kirbyHeaderActions"],["size","lg"],["name","kirby"],["themeColor","warning"],["class","custom-section",4,"kirbyHeaderCustomSection"],["name","arrow-down"],["kirby-button","","attentionLevel","3"],[1,"custom-section"],["size","sm","themeColor","success"]],template:function(t,a){t&1&&(o(0,"kirby-header",0),u("titleClick",function(f){return a.onTitleClick(f)}),v(1,kd,1,0,"kirby-icon",1)(2,fd,8,0,"kirby-action-group",2),o(3,"kirby-avatar",3),p(4,"kirby-icon",4),n(),o(5,"kirby-flag",5),l(6,"Warning"),n(),v(7,hd,3,0,"div",6),n()),t&2&&m("title","Title")},dependencies:[J,w,Wt,h,G,Fe,ae,ki,tt,Fo],styles:[".custom-section[_ngcontent-%COMP%]{display:flex;align-items:center;gap:8px;font-size:12px;color:var(--kirby-text-color-semi-dark)}"]});let i=e;return i})();function Cd(i,e){i&1&&p(0,"kirby-icon",4)}var xd={template:`<kirby-page defaultBackHref="/">
  ...
  // Do something...
}`,gt.\u0275fac=function(s){return new(s||gt)(x(A))},gt.\u0275cmp=d({type:gt,selectors:[["ng-component"]],features:[E],decls:5,vars:2,consts:[["defaultBackHref","/"],["value","12345,67","valueUnit","USD","subtitle1","Subtitle one","subtitle2","Subtitle two",3,"titleClick","title"],["name","arrow-down",4,"kirbyHeaderTitleActionIcon"],[3,"innerHTML"],["name","arrow-down"]],template:function(s,r){s&1&&(o(0,"kirby-page",0)(1,"kirby-header",1),u("titleClick",function(a){return r.onTitleClick(a)}),v(2,Cd,1,0,"kirby-icon",2),n(),o(3,"kirby-page-content"),p(4,"div",3),n()()),s&2&&(c(),m("title","Interactive Title"),c(3),m("innerHTML",r.content,Y))},dependencies:[$,J,w,ee],encapsulation:2});var ur=gt;function vd(i,e){if(i&1){let s=O();to(0),o(1,"kirby-menu")(2,"button",4),p(3,"kirby-icon",5),o(4,"span"),l(5,"Action"),n()(),o(6,"kirby-item",6),u("click",function(){S(s);let t=y();return M(t.actionClicked("Primary Action 1"))}),l(7," Primary Action 1 "),n(),o(8,"kirby-item",6),u("click",function(){S(s);let t=y();return M(t.actionClicked("Primary Action 2"))}),l(9," Primary Action 2 "),n()(),o(10,"kirby-menu")(11,"kirby-item",6),u("click",function(){S(s);let t=y();return M(t.actionClicked("Secondary Action 1"))}),l(12," Secondary Action 1 "),n(),o(13,"kirby-item",6),u("click",function(){S(s);let t=y();return M(t.actionClicked("Secondary Action 2"))}),l(14," Secondary Action 2 "),n()(),io()}i&2&&(c(6),m("selectable",!0),c(2),m("selectable",!0),c(3),m("selectable",!0),c(2),m("selectable",!0))}var _d={template:`<kirby-page defaultBackHref="/">
