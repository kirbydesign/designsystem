import{$b as ho,$c as Wt,$d as _i,Aa as We,Ac as wo,Ad as Le,Ae as $o,Ba as P,Bc as ci,Bd as ui,C as S,Cc as So,Cd as Xe,D as M,Da as b,Dc as Nt,Dd as gi,De as jo,Ea as y,Ec as f,Ed as V,Ee as Uo,Fa as ao,Fc as He,Fd as et,Fe as ze,Ga as lo,Gc as ce,Gd as F,Ha as It,Hc as mi,Ia as Ft,Ic as T,J as pe,Ja as Lt,Jc as Fe,Jd as yi,Ka as X,Kc as Kt,Kd as ki,L as Xt,Lc as di,Ma as R,Mc as pi,N as eo,Na as so,Nc as oe,Nd as zo,O as L,Oa as l,Ob as zt,Od as Ae,Pa as k,Pb as Bt,Pc as Mo,Pd as Gt,Qa as _,Qb as be,Qc as qt,Qd as ue,Ra as co,Rb as Ce,Rd as tt,S as U,Sb as ii,Sc as A,Sd as fi,Ta as Oe,Tb as Qt,Td as Bo,Ua as W,Ub as oi,Ud as No,V as to,Va as Ie,Vb as ni,Vd as J,Wa as De,Wb as ve,Wd as Ko,X as c,Xa as Bi,Xb as xe,Xc as Ze,Xd as hi,Yb as _e,Yc as Ht,Yd as Ci,Za as D,Zc as To,Zd as vi,_a as mo,_d as xi,ab as Z,ac as ri,ad as N,ae as qo,b as Zt,ba as v,bb as re,bc as qe,bd as Eo,be as Ho,cb as po,cc as ye,cd as Vt,ce as $t,da as d,db as bo,dc as we,dd as Po,de as ee,e as Yi,eb as ft,ed as H,ee as wi,fc as ai,fe as $,ga as E,gd as Se,ge as Ki,h as Qi,ha as x,hd as Me,he as Wo,ib as uo,ic as li,ie as jt,j as zi,jd as G,k as Ji,ka as Ne,kd as ht,la as O,ld as Do,ma as I,md as Oo,me as Ee,na as ei,nb as go,nd as Io,ne as le,oa as io,ob as At,od as B,oe as Pe,pa as K,pc as Ke,pd as ke,pe as it,qa as q,qb as yo,qc as Co,qd as ae,qe as ot,ra as m,rb as Qe,rc as si,rd as Fo,re as Vo,s as Zi,sa as o,sb as ti,sc as Ni,sd as Te,se as Si,t as Xi,ta as n,tb as ko,tc as Y,td as h,te as Ro,ua as p,ub as Je,uc as vo,ud as z,ue as Go,va as se,vb as fo,vd as Lo,ve as nt,wa as ne,wc as xo,wd as Q,xa as oo,xd as Rt,ya as no,yc as _o,yd as Ao,ye as me,za as ro,zc as w,zd as bi,ze as Mi}from"./chunk-AOKLXWNL.js";var _r={selector:"cookbook-item-example-sizes",template:`<kirby-item>
...
<kirby-radio-group>`},c2=(()=>{let e=class e{constructor(){this.template=pd.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-radio-sizes-example"]],decls:5,vars:0,consts:[["aria-label","Radio size example"],["size","xs","text","Extra Small"],["size","sm","text","Small"],["size","md","text","Medium (default)"]],template:function(t,a){t&1&&(o(0,"kirby-radio-group",0),p(1,"kirby-radio",1)(2,"kirby-radio",2)(3,"kirby-radio",3)(4,"kirby-radio-group"),n())},dependencies:[ae,ke],styles:['.kirby-line-clamp[_ngcontent-%COMP%]{display:-webkit-box;-webkit-line-clamp:var(--line-clamp, none);-webkit-box-orient:vertical;overflow:hidden}kirby-checkbox[_ngcontent-%COMP%], kirby-radio[_ngcontent-%COMP%]{margin-bottom:var(--kirby-spacing-xxs);background-color:var(--kirby-semi-light);position:relative}kirby-checkbox[_ngcontent-%COMP%]:before, kirby-checkbox[_ngcontent-%COMP%]:after, kirby-radio[_ngcontent-%COMP%]:before, kirby-radio[_ngcontent-%COMP%]:after{height:100%;border:1px solid var(--kirby-danger);position:absolute;right:0}kirby-checkbox[_ngcontent-%COMP%]:before, kirby-radio[_ngcontent-%COMP%]:before{content:"";border-left:0;border-right:0;width:calc(var(--kirby-spacing-xxs) + 1px)}kirby-checkbox[_ngcontent-%COMP%]:after, kirby-radio[_ngcontent-%COMP%]:after{content:"md: 56px";border-left:0;border-top:0;border-bottom:0;line-height:56px;font-size:var(--kirby-font-size-xs);color:var(--kirby-danger);padding-right:var(--kirby-spacing-xxs);margin-right:calc(var(--kirby-spacing-xxs) * .5);vertical-align:center}kirby-radio.xs[_ngcontent-%COMP%]:after{content:"xs: 32px";line-height:32px}kirby-radio.sm[_ngcontent-%COMP%]:after{content:"sm: 44px";line-height:44px}kirby-radio.md[_ngcontent-%COMP%]:after{content:"md: 56px";line-height:56px}kirby-checkbox.xs[_ngcontent-%COMP%]:after{content:"xs: 24px";line-height:24px}kirby-checkbox.sm[_ngcontent-%COMP%]:after{content:"sm: 44px";line-height:44px}kirby-checkbox.md[_ngcontent-%COMP%]:after{content:"md: 56px";line-height:56px}kirby-checkbox[_ngcontent-%COMP%]     ion-checkbox, kirby-radio[_ngcontent-%COMP%]     ion-radio{background-color:#f7e0f0;margin-right:80px}']});let i=e;return i})();var bd={selector:"cookbook-radio-multiline-example",template:`<kirby-radio
 ...
 sed do eiusmod tempor incididunt ut labore et dolore 
 magna aliqua.`]],template:function(t,a){t&1&&p(0,"kirby-radio",0)},dependencies:[ke],encapsulation:2});let i=e;return i})();var lr=[{title:"Bacon",value:1},{title:"Salami",value:2},{title:"Tenderloin",value:3},{title:"Veggie (not an option)",value:4,disabled:!0}],Ui={selector:"cookbook-radio-example-binding",template:`<kirby-radio-group
...
`)}onTitleClick(r){let t={message:"Title clicked...",messageType:"success",durationInMs:1500};this.toastController.showToast(t)}};e.\u0275fac=function(t){return new(t||e)(v(A))},e.\u0275cmp=d({type:e,selectors:[["cookbook-header-example-combined"]],decls:8,vars:1,consts:[["value","12.345,67","valueUnit","USD","subtitle1","Subtitle one","subtitle2","Subtitle two",3,"titleClick","title"],["name","arrow-down",4,"kirbyHeaderTitleActionIcon"],[4,"kirbyHeaderActions"],["size","lg"],["name","kirby"],["themeColor","warning"],["class","custom-section",4,"kirbyHeaderCustomSection"],["name","arrow-down"],["kirby-button","","attentionLevel","3"],[1,"custom-section"],["size","sm","themeColor","success"]],template:function(t,a){t&1&&(o(0,"kirby-header",0),b("titleClick",function(C){return a.onTitleClick(C)}),x(1,Ed,1,0,"kirby-icon",1)(2,Pd,8,0,"kirby-action-group",2),o(3,"kirby-avatar",3),p(4,"kirby-icon",4),n(),o(5,"kirby-flag",5),l(6,"Warning"),n(),x(7,Dd,3,0,"div",6),n()),t&2&&m("title","Title")},dependencies:[J,w,Gt,f,G,Le,le,fi,tt,Bo],styles:[".custom-section[_ngcontent-%COMP%]{display:flex;align-items:center;gap:8px;font-size:12px;color:var(--kirby-text-color-semi-dark)}"]});let i=e;return i})();function Od(i,e){i&1&&p(0,"kirby-icon",4)}var Id={template:`<kirby-page defaultBackHref="/">
  ...
  // Do something...
}`,gt.\u0275fac=function(s){return new(s||gt)(v(A))},gt.\u0275cmp=d({type:gt,selectors:[["ng-component"]],features:[E],decls:5,vars:2,consts:[["defaultBackHref","/"],["value","12345,67","valueUnit","USD","subtitle1","Subtitle one","subtitle2","Subtitle two",3,"titleClick","title"],["name","arrow-down",4,"kirbyHeaderTitleActionIcon"],[3,"innerHTML"],["name","arrow-down"]],template:function(s,r){s&1&&(o(0,"kirby-page",0)(1,"kirby-header",1),b("titleClick",function(a){return r.onTitleClick(a)}),x(2,Od,1,0,"kirby-icon",2),n(),o(3,"kirby-page-content"),p(4,"div",3),n()()),s&2&&(c(),m("title","Interactive Title"),c(3),m("innerHTML",r.content,U))},dependencies:[$,J,w,ee],encapsulation:2});var fr=gt;function Fd(i,e){if(i&1){let s=P();no(0),o(1,"kirby-menu")(2,"button",4),p(3,"kirby-icon",5),o(4,"span"),l(5,"Action"),n()(),o(6,"kirby-item",6),b("click",function(){S(s);let t=y();return M(t.actionClicked("Primary Action 1"))}),l(7," Primary Action 1 "),n(),o(8,"kirby-item",6),b("click",function(){S(s);let t=y();return M(t.actionClicked("Primary Action 2"))}),l(9," Primary Action 2 "),n()(),o(10,"kirby-menu")(11,"kirby-item",6),b("click",function(){S(s);let t=y();return M(t.actionClicked("Secondary Action 1"))}),l(12," Secondary Action 1 "),n(),o(13,"kirby-item",6),b("click",function(){S(s);let t=y();return M(t.actionClicked("Secondary Action 2"))}),l(14," Secondary Action 2 "),n()(),ro()}i&2&&(c(6),m("selectable",!0),c(2),m("selectable",!0),c(3),m("selectable",!0),c(2),m("selectable",!0))}var Ld={template:`<kirby-page defaultBackHref="/">
