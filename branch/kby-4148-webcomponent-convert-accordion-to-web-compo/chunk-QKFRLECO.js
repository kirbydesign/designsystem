import{$b as Te,$c as st,$d as ji,Aa as je,Ac as gn,Ad as J,Ae as ye,Ba as P,Bd as ei,Be as to,C as S,Cc as yn,Cd as Tn,Ce as $n,D as M,Da as b,Dc as w,Dd as Ki,Ea as h,Ec as hn,Ed as Ne,Fa as wi,Fc as Li,Fd as Ri,Fe as Oe,Ga as Si,Gd as ct,Ge as Hn,Ha as tn,Hc as zi,Hd as Wi,He as qn,Ia as Ut,Ic as f,Id as W,Ie as qe,J as ge,Ja as nt,Jc as Ge,Jd as mt,K as Uo,Ka as rt,Kc as ce,Kd as A,La as ee,Lc as Bi,Mc as T,N as vi,Na as V,Nc as ze,Nd as Vi,O as L,Oa as on,Oc as Jt,Od as Gi,P as jo,Pa as s,Pc as Ni,Qa as k,Qc as $i,Ra as _,Rc as ae,Rd as En,S as Y,Sa as nn,Sb as Yt,Sd as $e,Tb as Qt,Tc as kn,Td as ti,Ub as ke,Uc as Zt,Ud as fe,V as Yo,Va as Ae,Vb as Se,Vd as dt,Wa as R,Wb as Ei,Wc as z,Wd as Ui,X as c,Xa as Le,Xb as ci,Xd as Pn,Ya as Fe,Yb as Pi,Yd as Dn,Za as fo,Zb as Di,Zd as Z,_b as Me,_d as On,ab as D,ac as Ee,ad as me,ae as Yi,b as xi,ba as x,bb as rn,bd as Xt,be as Qi,cd as fn,ce as Ji,da as d,db as X,dc as pn,de as Zi,e as Ko,eb as se,ec as Oi,ed as Hi,ee as In,fa as Qo,fb as an,fc as Ve,fd as $,fe as Fn,ga as E,gb as ln,gc as xe,gd as Cn,ge as ii,h as Ro,ha as v,hb as Pt,hc as Pe,hd as qi,he as te,id as xn,ie as Xi,j as ko,jc as Ii,jd as K,je as U,k as Wo,ka as Re,ke as An,la as O,lb as Mi,ld as De,le as Ln,ma as I,mc as Fi,me as oi,na as _i,nd as G,oa as Jo,od as Dt,pa as H,pd as vn,qa as q,qb as sn,qd as _n,qe as He,ra as m,rb as jt,rd as wn,re as pt,s as Vo,sa as n,sd as B,se as ut,t as Go,ta as r,tb as cn,tc as We,td as ve,te as zn,ua as p,ub as at,uc as un,ud as de,ue as eo,va as pe,vb as Ti,vc as Ai,vd as Sn,ve as Bn,wa as le,wb as mn,wc as Co,wd as Be,we as Nn,xa as Zo,xb as lt,xc as Q,xd as C,xe as bt,ya as Xo,yc as bn,yd as N,za as en,zb as dn,zd as Mn}from"./chunk-ICZ7OGTY.js";var La={selector:"cookbook-item-example-sizes",template:`<kirby-item>
...
`;var ai=function(i,e,l,o){var t=arguments.length,a=t<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,l):o,g;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(i,e,l,o);else for(var y=i.length-1;y>=0;y--)(g=i[y])&&(a=(t<3?g(a):t>3?g(e,l,a):g(e,l))||a);return t>3&&a&&Object.defineProperty(e,l,a),a},mr=0,dr=(()=>{let e=class e extends so{constructor(){super(...arguments),this.title="",this.isExpanded=!1,this.isDisabled=!1,this.disabledTitle="",this.hasPadding=!0,this._titleId=`kirby-accordion-item-title-${++mr}`,this._contentId=`kirby-accordion-item-content-${mr}`}getTitle(){return this.isDisabled&&this.disabledTitle?this.disabledTitle:this.title}onToggleExpanded(o){o.preventDefault(),!this.isDisabled&&(this.isExpanded=!this.isExpanded,this.dispatchEvent(new CustomEvent("toggle",{detail:this.isExpanded,bubbles:!0,composed:!0})))}firstUpdated(){let o=this.renderRoot.querySelector("slot");o&&o.addEventListener("slotchange",()=>{o.assignedElements({flatten:!0}).forEach(a=>{a.tagName==="KIRBY-LIST"&&a.setAttribute("shape","none")})})}willUpdate(o){o.has("isDisabled")&&this.isDisabled&&(this.isExpanded=!1)}render(){return rr`
    ...
    `}};e.tagName="kirby-accordion-item",e.styles=[sr,cr];let i=e;return ai([ht({type:String})],i.prototype,"title",void 0),ai([ht({type:Boolean,reflect:!0})],i.prototype,"isExpanded",void 0),ai([ht({type:Boolean,reflect:!0})],i.prototype,"isDisabled",void 0),ai([ht({type:String})],i.prototype,"disabledTitle",void 0),ai([ht({type:Boolean,reflect:!0})],i.prototype,"hasPadding",void 0),ai([ht({type:Number})],i.prototype,"headingLevel",void 0),i})();var nl=["*"],rl=(()=>{let e=class e{constructor(){this._isExpanded=!1,this._hasPadding=!0,this._isDisabled=!1}get isExpanded(){return this._isExpanded}set isExpanded(o){this._isExpanded=o}get hasPadding(){return this._hasPadding}set hasPadding(o){this._hasPadding=o}get isDisabled(){return this._isDisabled}set isDisabled(o){this._isDisabled=o}ngAfterContentInit(){this.listChildren&&this.listChildren.length>0&&(this.hasPadding=!1,this.listChildren.forEach(o=>{o.shape="none"}))}ngOnChanges(){this.isDisabled&&(this.isExpanded=!1)}};e.\u0275fac=function(t){return new(t||e)},e.\u0275dir=Qo({type:e,contentQueries:function(t,a,g){if(t&1&&tn(g,K,4),t&2){let y;nt(y=rt())&&(a.listChildren=y)}},features:[vi]});let i=e;return i})(),Ie=(()=>{let e=class e extends rl{constructor(o,t,a){super(),this.e=o,this.ngZone=t,this.cdr=a,this.toggle=new ge,this.el=this.e.nativeElement,this.cdr.detach(),this.el.addEventListener("toggle",g=>{this.toggle.emit(g)})}set title(o){this.ngZone.runOutsideAngular(()=>this.el.title=o)}get title(){return this.el.title}set isExpanded(o){this.ngZone.runOutsideAngular(()=>this.el.isExpanded=o)}get isExpanded(){return this.el.isExpanded}set isDisabled(o){this.ngZone.runOutsideAngular(()=>this.el.isDisabled=o)}get isDisabled(){return this.el.isDisabled}set disabledTitle(o){this.ngZone.runOutsideAngular(()=>this.el.disabledTitle=o)}get disabledTitle(){return this.el.disabledTitle}set hasPadding(o){this.ngZone.runOutsideAngular(()=>this.el.hasPadding=o)}get hasPadding(){return this.el.hasPadding}set headingLevel(o){this.ngZone.runOutsideAngular(()=>this.el.headingLevel=o)}get headingLevel(){return this.el.headingLevel}};e.\u0275fac=function(t){return new(t||e)(x(jo),x(Uo),x(Mi))},e.\u0275cmp=d({type:e,selectors:[["kirby-accordion-item"]],inputs:{title:"title",isExpanded:"isExpanded",isDisabled:"isDisabled",disabledTitle:"disabledTitle",hasPadding:"hasPadding",headingLevel:"headingLevel"},outputs:{toggle:"toggle"},features:[E],ngContentSelectors:nl,decls:1,vars:0,template:function(t,a){t&1&&(wi(),Si(0))},encapsulation:2,changeDetection:0});let i=e;return i})();dr.define();var al={selector:"cookbook-accordion-default-example",template:`<kirby-accordion>
...
<kirby-icon name="person" size="xs"></kirby-icon>`},zt=class zt{constructor(){this.sizes=yn}};zt.htmlSnippet=Pc.htmlSnippet,zt.\u0275fac=function(l){return new(l||zt)},zt.\u0275cmp=d({type:zt,selectors:[["cookbook-icon-sizes-example"]],decls:3,vars:2,consts:[[1,"icon-item-container"],[1,"icon-item-inner-container"],["name","person",3,"size","title"],[1,"icon-item-title"]],template:function(l,o){l&1&&(H(0,Ec,5,3,"div",0,Tc),X(2,"keyvalue")),l&2&&q(se(2,0,o.sizes))},dependencies:[w,Ti],styles:['@keyframes _ngcontent-%COMP%_slide-in-out{0%{opacity:0;transform:translateY(-50%)}10%{opacity:1;transform:translateY(-125%)}90%{opacity:1;transform:translateY(-125%)}to{opacity:0;transform:translateY(-200%)}}[_nghost-%COMP%]{display:block}p[_ngcontent-%COMP%]{margin-top:16px}.icon-item-container[_ngcontent-%COMP%]{width:112px;padding:8px;display:inline-block;text-align:center}.icon-item-inner-container[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;height:100%;flex-wrap:wrap}.icon-item-title[_ngcontent-%COMP%]{display:block;max-width:112px;font-size:12px;color:#0009;white-space:nowrap}kirby-icon[_ngcontent-%COMP%]{width:100%}kirby-icon.copy-to-clipboard[_ngcontent-%COMP%]{transition:transform .2s;cursor:pointer}kirby-icon.copy-to-clipboard[_ngcontent-%COMP%]:hover{transform:scale(1.2)}kirby-icon.copy-to-clipboard[_ngcontent-%COMP%]:before{display:block;position:absolute;content:"Copied!";background-color:var(--kirby-semi-light);color:var(--kirby-semi-dark-contrast);font-size:10px;padding:2px 4px;border-radius:4px;opacity:0;transform:translateY(-50%)}kirby-icon.copy-to-clipboard.copied[_ngcontent-%COMP%]:before{opacity:1;animation-name:_ngcontent-%COMP%_slide-in-out;animation-duration:1.5s;animation-fill-mode:forwards}.color-options[_ngcontent-%COMP%]{display:flex;justify-content:center;gap:8px;padding:8px}button[_ngcontent-%COMP%]{height:44px;width:44px;border:none;border-radius:50%;margin:0;color:var(--kirby-black);cursor:pointer}button.primary[_ngcontent-%COMP%]{background-color:var(--kirby-primary)}button.primary[_ngcontent-%COMP%]:hover{background-color:var(--kirby-primary-shade)}button.secondary[_ngcontent-%COMP%]{background-color:var(--kirby-secondary)}button.secondary[_ngcontent-%COMP%]:hover{background-color:var(--kirby-secondary-shade)}button.tertiary[_ngcontent-%COMP%]{background-color:var(--kirby-tertiary)}button.tertiary[_ngcontent-%COMP%]:hover{background-color:var(--kirby-tertiary-shade)}button.success[_ngcontent-%COMP%]{background-color:var(--kirby-success)}button.success[_ngcontent-%COMP%]:hover{background-color:var(--kirby-success-shade)}button.warning[_ngcontent-%COMP%]{background-color:var(--kirby-warning)}button.warning[_ngcontent-%COMP%]:hover{background-color:var(--kirby-warning-shade)}button.danger[_ngcontent-%COMP%]{background-color:var(--kirby-danger)}button.danger[_ngcontent-%COMP%]:hover{background-color:var(--kirby-danger-shade)}button[_ngcontent-%COMP%]:active{transform:scale(.95)}']});var Br=zt;var Nr={selector:"cookbook-icon-custom-example",template:`<div class="icon-item-container">
  <div class="icon-item-inner-container">
...
`,p1=(()=>{let e=class e extends Ct{constructor(){super(...arguments),this.template=Zc}};e.\u0275fac=(()=>{let o;return function(a){return(o||(o=L(e)))(a||e)}})(),e.\u0275cmp=d({type:e,selectors:[["cookbook-multi-card-list-no-shape-example"]],features:[E],decls:2,vars:2,consts:[["shape","none","hasItemSpacing","true",3,"items","showDivider"],[4,"kirbyListItemTemplate"],["title","Account is overdraft",3,"flagged"],[1,"kirby-text-bold"],["slot","end",1,"kirby-text-bold",3,"value"],["slot","end",3,"value"]],template:function(t,a){t&1&&(n(0,"kirby-list",0),v(1,Jc,10,6,"kirby-card",1),r()),t&2&&m("items",a.items)("showDivider",!1)},dependencies:[K,$,T,C,ce,lt],encapsulation:2});let i=e;return i})();function Xc(i,e){if(i&1&&(n(0,"kirby-item")(1,"p",2),s(2),r(),n(3,"data",3),s(4),r()()),i&2){let l=e.$implicit;c(2),k(l.title),c(2),k(l.amount)}}var em=`<kirby-list [items]="items" [showDivider]="false">
  <kirby-item *kirbyListItemTemplate="let item">
    <p class="kirby-item-title">{{item.title}}</p>
...
} `},we=class we{constructor(e){this.modalController=e}navigateToModalRoute(e,l){this.modalController.navigateToModal(e,l)}};we.template=Je.template,we.defaultCodeSnippet=Je.defaultCodeSnippet,we.modalRouteCodeSnippet=Je.modalRouteCodeSnippet,we.modalRouteWithGuardCodeSnippet=Je.modalRouteWithGuardCodeSnippet,we.deeplinkedRouterLinkWithUrlParamCodeSnippet=Je.deeplinkedRouterLinkWithUrlParamCodeSnippet,we.routerLinkForModalOutletCodeSnippet=Je.routerLinkForModalOutletCodeSnippet,we.modalControllerForModalOutletCodeSnippet=Je.modalControllerForModalOutletCodeSnippet,we.routerLinkWithinModalOutletCodeSnippet=Je.routerLinkWithinModalOutletCodeSnippet,we.modalControllerWithinModalOutletCodeSnippet=Je.modalControllerWithinModalOutletCodeSnippet,we.\u0275fac=function(l){return new(l||we)(x(ae))},we.\u0275cmp=d({type:we,selectors:[["cookbook-modal-example-outlet"]],decls:4,vars:2,consts:[["kirby-button","",3,"click"],["kirby-button","","kirbyModalRouterLink","page1",3,"kirbyModalQueryParams"]],template:function(l,o){l&1&&(n(0,"button",0),b("click",function(){return o.navigateToModalRoute("page1",{awesomeQueryParam:"awesome value"})}),s(1,"Open modal by route"),r(),n(2,"button",1),s(3,"Open modal by router link"),r()),l&2&&(c(2),m("kirbyModalQueryParams",D(1,td)))},dependencies:[f,qn,Hn],styles:[".example-container[_ngcontent-%COMP%]{margin:32px auto;max-width:768px}.example-frame[_ngcontent-%COMP%]{position:relative;border:1px solid var(--kirby-medium);border-radius:12px;padding:32px}.example-frame.no-padding[_ngcontent-%COMP%]{padding:0}@media(max-width:767px){.example-frame[_ngcontent-%COMP%]{margin-inline:-16px;padding-inline:16px}}[_nghost-%COMP%]{display:block;height:100%;overflow-x:hidden;background:var(--kirby-background-color);padding-inline:24px;padding-block:16px;box-sizing:border-box}@media(min-width:768px){[_nghost-%COMP%]{padding:32px}}[_nghost-%COMP%]   h2[_ngcontent-%COMP%]:not(:first-child){margin-top:32px}[_nghost-%COMP%]   h3[_ngcontent-%COMP%]{margin-top:12px;margin-bottom:4px}[_nghost-%COMP%]{display:grid;place-content:center;overflow-y:auto}[_nghost-%COMP%] > button[_ngcontent-%COMP%]{min-width:15rem}"]});var Wr=we;var zo={selector:"cookbook-modal-example-simple",template:`<button kirby-button size="lg" (click)="showModal('modal', size)">Show modal</button>
...
</kirby-page>`},$t=class $t extends j{constructor(e,l){super(),this.toastController=e,this.modalController=l,this.items=[{id:"1",text:"Option 1"},{id:"2",text:"Option 2"},{id:"3",text:"Option 3"}]}onItemSelect(e){if(!e)return;let l={message:`'${e.text}' was selected.`,messageType:"success",durationInMs:1500};this.toastController.showToast(l)}onCogSelect(){let e={message:"Settings was selected.",messageType:"success",durationInMs:1500};this.toastController.showToast(e)}onMoreSelect(){let e={header:"Your action sheet header",items:this.items};this.modalController.showActionSheet(e,this.onItemSelect.bind(this))}};$t.template=fd.template.replace(' defaultBackHref="/"',"").replace(' [innerHTML]="content">',">..."),$t.\u0275fac=function(l){return new(l||$t)(x(z),x(ae))},$t.\u0275cmp=d({type:$t,selectors:[["ng-component"]],features:[E],decls:12,vars:4,consts:[["customTitle",""],["customSubtitle",""],["defaultBackHref","/"],[4,"kirbyPageTitle"],[4,"kirbyPageSubtitle"],["kirbyPageToolbarTitle",""],[4,"kirbyPageActions"],[3,"innerHTML",4,"kirbyPageContent"],["horizontalAlignment","right",4,"kirbyPageContent"],[1,"kirby-text-xlarge"],[4,"ngTemplateOutlet"],["kirby-button","","aria-label","More",3,"click"],["name","more"],["kirby-button","","aria-label","Settings",3,"click"],["name","cog"],[3,"innerHTML"],["horizontalAlignment","right"],["name","write-message"],["header","Your action sheet header","subheader","Your action sheet subheader",3,"itemSelect","items"]],template:function(l,o){l&1&&(n(0,"kirby-page",2),v(1,cd,3,1,"div",3)(2,md,2,0,"div",4)(3,pd,1,1,"ng-template",5)(4,ud,1,0,"ng-template",null,0,Pt)(6,bd,1,0,"ng-template",null,1,Pt)(8,gd,3,0,"kirby-page-actions",6)(9,yd,3,0,"kirby-page-actions",6)(10,hd,1,1,"div",7)(11,kd,3,1,"kirby-fab-sheet",8),r()),l&2&&(c(8),m("kirbyPageActions",D(2,Qr)),c(3),m("kirbyPageContent",D(3,Qr)))},dependencies:[Xi,jt,f,w,Ki,$i,U,Yi,Qi,ji,Zi,Ji],styles:[".custom-page-title[_ngcontent-%COMP%]{display:inline-flex}"]});var Jr=$t;var Cd=()=>({fixed:!0}),xd=()=>({maxLines:2});function vd(i,e){i&1&&(n(0,"div")(1,"div",6)(2,"span",7),s(3," Custom Titles with very long names that span multiple lines will be truncated "),r(),p(4,"kirby-icon",8),r()()),i&2&&(c(2),m("kirbyFitHeading",D(1,xd)))}function _d(i,e){i&1&&(n(0,"div"),s(1," Custom subtitles with very long names that span multiple lines will wrap. "),r())}function wd(i,e){i&1&&(n(0,"div",9)(1,"div",10),s(2," Custom Titles with very long names that span multiple lines will be truncated "),r(),p(3,"kirby-icon",8),r())}function Sd(i,e){if(i&1){let l=P();n(0,"kirby-page-actions")(1,"button",11),b("click",function(){S(l);let t=h();return M(t.onMoreSelect())}),p(2,"kirby-icon",12),r()()}}function Md(i,e){if(i&1){let l=P();n(0,"kirby-page-actions")(1,"button",13),b("click",function(){S(l);let t=h();return M(t.onCogSelect())}),p(2,"kirby-icon",14),r()()}}function Td(i,e){if(i&1&&p(0,"div",15),i&2){let l=h();m("innerHTML",l.content,Y)}}var Ed={template:`<kirby-page defaultBackHref="/">
  ...
  <kirby-card>
    ...
    <kirby-item>
      ...
      kirby-card:first-of-type {
        margin-bottom: 24px;
      }`]},Kt=class Kt extends j{constructor(e){super(),this.route=e,this.showTabs=!0,this.showFooter=!0}ngOnInit(){this.title=this.route.snapshot.data.title}toggleTabs(){this.showTabs=!this.showTabs}toggleFooter(){this.showFooter=!this.showFooter}onCloseClick(){this.pageFooter.close(),this.showFooter=!1,this.showTabs=!0}};Kt.template=ia.replace(/<kirby-page-content[^>]*>(.|\s)*?<\/kirby-page-content>/,"<kirby-page-content>...</kirby-page-content>"),Kt.\u0275fac=function(l){return new(l||Kt)(x(Ii))},Kt.\u0275cmp=d({type:Kt,selectors:[["ng-component"]],viewQuery:function(l,o){if(l&1&&Ut(An,5),l&2){let t;nt(t=rt())&&(o.pageFooter=t.first)}},features:[E],decls:8,vars:6,consts:[["controls",""],[3,"title","tabBarBottomHidden"],[4,"ngTemplateOutlet"],[3,"innerHTML"],["kirby-button","","attentionLevel","2","aria-label","Close",1,"close-footer-btn",3,"click"],["name","close"],["slot","end",3,"click","checked"]],template:function(l,o){if(l&1&&(n(0,"kirby-page",1)(1,"kirby-page-content"),v(2,Od,1,0,"ng-container",2),p(3,"div",3),v(4,Id,1,0,"ng-container",2),r(),O(5,Fd,6,0,"kirby-page-footer"),r(),v(6,Ad,9,2,"ng-template",null,0,Pt)),l&2){let t=ee(7);m("title",o.title)("tabBarBottomHidden",!o.showTabs),c(2),m("ngTemplateOutlet",t),c(),m("innerHTML",o.content,Y),c(),m("ngTemplateOutlet",t),c(),I(o.showFooter?5:-1)}},dependencies:[U,jt,f,w,T,C,Be,te],styles:[".close-footer-btn[_ngcontent-%COMP%]{position:absolute;top:8px;right:16px;margin:0}kirby-card[_ngcontent-%COMP%]:first-of-type{margin-bottom:24px}"]});var ta=Kt;var zd=()=>({fixed:!0});function Bd(i,e){if(i&1){let l=P();n(0,"kirby-page-actions")(1,"button",3),b("click",function(){S(l);let t=h();return M(t.onMoreSelect())}),p(2,"kirby-icon",4),r()()}}var Nd={template:`<kirby-page>
...
</kirby-page>`},et=class et extends j{constructor(e,l){super(),this.toastController=e,this.modalController=l,this.items=[{id:"1",text:"Option 1"},{id:"2",text:"Option 2"},{id:"3",text:"Option 3"}]}onItemSelect(e){if(!e)return;let l={message:`'${e.text}' was selected.`,messageType:"success",durationInMs:1500};this.toastController.showToast(l)}onCogSelect(){let e={message:"Settings was selected.",messageType:"success",durationInMs:1500};this.toastController.showToast(e)}onMoreSelect(){let e={header:"Your action sheet header",items:this.items};this.modalController.showActionSheet(e,this.onItemSelect.bind(this))}};et.template=Hd.template.replace(' defaultBackHref="/"',"").replace('<div [innerHTML]="content"></div>',"..."),et.customTitleTemplate=Nd.template,et.fixedActionsTemplate=$d.template,et.\u0275fac=function(l){return new(l||et)(x(z),x(ae))},et.\u0275cmp=d({type:et,selectors:[["ng-component"]],features:[E],decls:4,vars:3,consts:[["toolbarTitle","A Fixed Title","defaultBackHref","/"],[4,"kirbyPageActions"],[3,"innerHTML"],["kirby-button","","aria-label","More",3,"click"],["name","more"]],template:function(l,o){l&1&&(n(0,"kirby-page",0),v(1,Bd,3,0,"kirby-page-actions",1),n(2,"kirby-page-content"),p(3,"div",2),r()()),l&2&&(c(),m("kirbyPageActions",D(2,zd)),c(2),m("innerHTML",o.content,Y))},dependencies:[U,f,w,te],encapsulation:2});var oa=et;var qd={template:`<kirby-page title="Pull-to-refresh" defaultBackHref="/" (refresh)="loadData($event)">
  <kirby-page-content>
    <div [innerHTML]="content"></div>
  </kirby-page-content>
</kirby-page>`},tt=class tt extends j{loadData(e){console.log("Begin async operation"),setTimeout(()=>{console.log("Async operation has ended"),e.complete()},3e3)}};tt.template=qd.template.replace(' defaultBackHref="/"',"").replace('<div [innerHTML]="content"></div>',"..."),tt.handler=`loadData(event: PullToRefreshEvent) {
...
}`,tt.\u0275fac=(()=>{let e;return function(o){return(e||(e=L(tt)))(o||tt)}})(),tt.\u0275cmp=d({type:tt,selectors:[["ng-component"]],features:[E],decls:3,vars:1,consts:[["title","Pull-to-refresh","defaultBackHref","/",3,"refresh"],[3,"innerHTML"]],template:function(l,o){l&1&&(n(0,"kirby-page",0),b("refresh",function(a){return o.loadData(a)}),n(1,"kirby-page-content"),p(2,"div",1),r()()),l&2&&(c(2),m("innerHTML",o.content,Y))},dependencies:[U,te],encapsulation:2});var na=tt;function Kd(i,e){if(i&1&&(n(0,"code",6),s(1),r()),i&2){let l=h().$implicit;c(),_('maxWidth="',l.value,'"')}}function Rd(i,e){if(i&1&&(n(0,"kirby-item",4)(1,"kirby-label")(2,"p",5),s(3),r(),O(4,Kd,2,1,"code",6),r(),n(5,"kirby-label",7)(6,"data",6),s(7),r()()()),i&2){let l=e.$implicit,o=e.selected,t=e.focused;V("focused",t),m("selected",o),c(3),k(l.text),c(),I(l.value!=="default"?4:-1),c(3),k(l.width)}}var bo=un.pageContentMaxWidth,aa=`
  <fieldset>
...
</kirby-slides>`},fM=(()=>{let e=class e{constructor(){this.template=gp.template,this.slides=[...Array(9).keys()].map(o=>({title:`Slide ${o+1}`,subtitle:`Subtitle ${o+1}`,cardContent:"Lorem ipsum dolor sit amet consectetur adipisicing elit."}))}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-slides-custom-heading-example"]],decls:4,vars:2,consts:[[3,"slides","showNavigation"],[3,"hasPadding",4,"kirbySlide"],[3,"hasPadding"],[3,"title","subtitle"],[1,"card-content"]],template:function(t,a){t&1&&(n(0,"kirby-slides",0)(1,"h3"),s(2,"Custom heading"),r(),v(3,bp,4,4,"kirby-card",1),r()),t&2&&m("slides",a.slides)("showNavigation",!0)},dependencies:[ut,pt,T,ce],styles:["[_nghost-%COMP%]{--padding-start: 16px;--padding-end: 16px}kirby-card[_ngcontent-%COMP%]{justify-content:start}"]});let i=e;return i})();function yp(i,e){if(i&1&&(n(0,"kirby-card",2),p(1,"kirby-card-header",3),n(2,"div",4),s(3),r()()),i&2){let l=e.$implicit;m("hasPadding",!0),c(),m("title",l.title)("subtitle",l.subtitle),c(2),_(" ",l.cardContent," ")}}var hp={selector:"cookbook-slides-height-example",template:`<kirby-slides [slides]="slides" [title]="'Title'" [showNavigation]="true">
...
</kirby-slides>`},TM=(()=>{let e=class e{constructor(){this.template=fp.template,this.slides=[...Array(9).keys()].map(o=>({title:`Slide ${o+1}`,subtitle:`Subtitle ${o+1}`,cardContent:"Lorem ipsum dolor sit amet consectetur adipisicing elit."}))}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-slides-simple-example"]],decls:2,vars:3,consts:[[3,"slides","title","showNavigation"],[3,"hasPadding",4,"kirbySlide"],[3,"hasPadding"],[3,"title","subtitle"],[1,"card-content"]],template:function(t,a){t&1&&(n(0,"kirby-slides",0),v(1,kp,4,4,"kirby-card",1),r()),t&2&&m("slides",a.slides)("title","Title")("showNavigation",!0)},dependencies:[ut,pt,T,ce],styles:["[_nghost-%COMP%]{--padding-start: 16px;--padding-end: 16px}kirby-card[_ngcontent-%COMP%]{justify-content:start}"]});let i=e;return i})();function Cp(i,e){if(i&1&&(n(0,"kirby-card",5),p(1,"kirby-card-header",6),n(2,"div"),s(3),r()()),i&2){let l=e.$implicit;m("hasPadding",!0),c(),m("title",l.title)("subtitle",l.subtitle),c(2),k(l.cardContent)}}var xp={selector:"cookbook-slides-advanced-example",template:`<kirby-slides
...
</kirby-page>`},Gt=class Gt extends j{constructor(e){super(),this.toastController=e}actionClicked(e){let l={message:`${e} was selected.`,messageType:"success",durationInMs:1500};this.toastController.showToast(l)}};Gt.template=au.template.replace(' defaultBackHref="/"',"").replace(' [innerHTML]="content">',">..."),Gt.\u0275fac=function(l){return new(l||Gt)(x(z))},Gt.\u0275cmp=d({type:Gt,selectors:[["ng-component"]],features:[E],decls:5,vars:2,consts:[["defaultBackHref","/"],["subtitle1","Subtitle one","subtitle2","Subtitle two",3,"title"],[4,"kirbyHeaderActions"],[3,"innerHTML"],["kirby-button","","attentionLevel","3",3,"click"],["name","edit"],[1,"text"]],template:function(l,o){l&1&&(n(0,"kirby-page",0)(1,"kirby-header",1),v(2,ru,9,0,"kirby-action-group",2),r(),n(3,"kirby-page-content"),p(4,"div",3),r()()),l&2&&(c(),m("title","Action Group"),c(3),m("innerHTML",o.content,Y))},dependencies:[U,Z,ti,f,w,te,dt],encapsulation:2});var Aa=Gt;var lu={selector:"cookbook-menu-selectable-example",template:`<kirby-menu>
