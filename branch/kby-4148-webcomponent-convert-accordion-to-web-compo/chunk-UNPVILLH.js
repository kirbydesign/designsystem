import{$b as Te,$c as mt,$d as ji,Aa as je,Ac as hn,Ad as J,Ae as he,Ba as P,Bd as ti,Be as to,C as S,Cc as yn,Cd as En,Ce as Hn,D as M,Da as b,Dc as w,Dd as Ki,Ea as y,Ec as kn,Ed as Ne,Fa as wi,Fc as Li,Fd as Ri,Fe as Oe,Ga as Si,Gd as dt,Ge as qn,Ha as on,Hc as zi,Hd as Wi,He as Kn,Ia as jt,Ic as f,Id as W,Ie as qe,J as ge,Ja as at,Jc as Ge,Jd as pt,K as jo,Ka as lt,Kc as ce,Kd as A,La as ee,Lc as Bi,Mc as T,N as vi,Na as V,Nc as ze,Nd as Vi,O as L,Oa as nn,Oc as Zt,Od as Gi,P as Yo,Pa as s,Pc as Ni,Qa as k,Qc as $i,Ra as _,Rc as ae,Rd as Pn,S as Y,Sa as rn,Sb as Qt,Sd as $e,Tb as Jt,Tc as fn,Td as ii,Ub as ke,Uc as Xt,Ud as fe,V as Qo,Va as Ae,Vb as Se,Vd as ut,Wa as R,Wb as Ei,Wc as z,Wd as Ui,X as c,Xa as Le,Xb as ci,Xd as Dn,Ya as Fe,Yb as Pi,Yd as On,Za as Co,Zb as Di,Zd as Z,_b as Me,_d as In,ab as D,ac as Ee,ad as me,ae as Yi,b as xi,ba as x,bb as an,bd as ei,be as Qi,cd as Cn,ce as Ji,da as d,db as X,dc as un,de as Zi,e as Ro,eb as se,ec as Oi,ed as Hi,ee as Fn,fa as Jo,fb as ln,fc as Ve,fd as $,fe as An,ga as E,gb as sn,gc as xe,gd as xn,ge as oi,h as Wo,ha as v,hb as Dt,hc as Pe,hd as qi,he as te,id as vn,ie as Xi,j as fo,jc as Ii,jd as K,je as U,k as Vo,ka as Re,ke as Ln,la as O,lb as Mi,ld as De,le as zn,ma as I,mc as Fi,me as ni,na as _i,nd as G,oa as Zo,od as Ot,pa as H,pd as _n,qa as q,qb as cn,qd as wn,qe as He,ra as m,rb as Yt,rd as Sn,re as bt,s as Go,sa as n,sd as B,se as gt,t as Uo,ta as r,tb as mn,tc as We,td as ve,te as Bn,ua as p,ub as st,uc as bn,ud as de,ue as eo,va as pe,vb as Ti,vc as Ai,vd as Mn,ve as Nn,wa as le,wb as dn,wc as xo,wd as Be,we as $n,xa as Xo,xb as ct,xc as Q,xd as C,xe as ht,ya as en,yc as gn,yd as N,za as tn,zb as pn,zd as Tn}from"./chunk-KCJZYOA6.js";var $a={selector:"cookbook-item-example-sizes",template:`<kirby-item>
...
`;var Lt=function(i,e,l,o){var t=arguments.length,a=t<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,l):o,g;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(i,e,l,o);else for(var h=i.length-1;h>=0;h--)(g=i[h])&&(a=(t<3?g(a):t>3?g(e,l,a):g(e,l))||a);return t>3&&a&&Object.defineProperty(e,l,a),a},br=0,gr=(()=>{let e=class e extends co{constructor(){super(...arguments),this.title="",this.isExpanded=!1,this.isDisabled=!1,this.disabledTitle="",this.hasPadding=!0,this.shape="none",this._titleId=`kirby-accordion-item-title-${++br}`,this._contentId=`kirby-accordion-item-content-${br}`}getTitle(){return this.isDisabled&&this.disabledTitle?this.disabledTitle:this.title}_onToggleExpanded(o){o.preventDefault(),!this.isDisabled&&(this.isExpanded=!this.isExpanded,this.dispatchEvent(new CustomEvent("toggle",{detail:this.isExpanded,bubbles:!0,composed:!0})))}connectedCallback(){super.connectedCallback(),this.closest("kirby-card")&&this.classList.add("in-card")}firstUpdated(){let o=this.renderRoot.querySelector("slot");o&&o.addEventListener("slotchange",()=>{o.assignedElements({flatten:!0}).forEach(a=>{a.tagName==="KIRBY-LIST"&&a.setAttribute("shape","none")})})}updated(o){o.has("isDisabled")&&this.isDisabled&&(this.isExpanded=!1)}render(){return ar`
      <div class="content-layer" aria-disabled=${this.isDisabled}>
        ...
        <div class="content" role="region" aria-labelledby=${this._titleId} id=${this._contentId}>
          <div class="content-body ${dr({padding:this.hasPadding})}">
            <slot></slot>
          </div>
        </div>
      </div>
...
];`},_k=(()=>{let e=class e{constructor(){this.template=Ir.template,this.codeSnippet=Ir.codeSnippet,this.checkboxItems=[{label:"Checkbox 1",checked:!0},{label:"Checkbox 2",checked:!1},{label:"Checkbox 3",checked:!1}]}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-checkbox-list-example"]],decls:2,vars:2,consts:[[3,"items","showDivider"],[4,"kirbyListItemTemplate"],["slot","start",3,"checked"]],template:function(t,a){t&1&&(n(0,"kirby-list",0),v(1,Cs,4,2,"kirby-item",1),r()),t&2&&m("items",a.checkboxItems)("showDivider",!0)},dependencies:[K,C,B,$],encapsulation:2});let i=e;return i})();var xs={selector:"cookbook-checkbox-states-example",template:`<kirby-checkbox text="Default"></kirby-checkbox>
...
></kirby-dropdown>`},sf=(()=>{let e=class e{constructor(){this.template=Ns.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-dropdown-example-scroll"]],decls:1,vars:2,consts:[["aria-label","Choose your favorite fruit","placeholder","Dropdown with scroll (> 8 items)",3,"items"]],template:function(t,a){t&1&&p(0,"kirby-dropdown",0),t&2&&m("items",D(1,Bs))},dependencies:[J],encapsulation:2});let i=e;return i})();var $s=()=>["Apple","Banana","Blackberry","Blueberry","Grapes (preselected)"],Hs={selector:"cookbook-dropdown-example-pre-selected",template:`<kirby-dropdown
  aria-label="Choose your favorite fruit"
  [items]="[
    'Apple',
    'Banana',
  ...
  [selectedIndex]="4"
></kirby-dropdown>`},df=(()=>{let e=class e{constructor(){this.template=Hs.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-dropdown-example-pre-selected"]],decls:1,vars:3,consts:[["aria-label","Choose your favorite fruit",3,"items","selectedIndex"]],template:function(t,a){t&1&&p(0,"kirby-dropdown",0),t&2&&m("items",D(2,$s))("selectedIndex",4)},dependencies:[J],encapsulation:2});let i=e;return i})();var qs=()=>["Apple","Banana","Blackberry","Blueberry","Grapes"],Ks={selector:"cookbook-dropdown-example-expand",template:`<kirby-dropdown
...
`},Gf=(()=>{let e=class e{constructor(){this.template=Js.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-dropdown-example-form-field"]],decls:5,vars:9,consts:[[1,"column-layout","constrain-width"],[3,"label","message"],["placeholder","Dropdown in form field",3,"items"],["placeholder","Dropdown in form field",3,"size","items"]],template:function(t,a){t&1&&(n(0,"div",0)(1,"kirby-form-field",1),p(2,"kirby-dropdown",2),r(),n(3,"kirby-form-field",1),p(4,"kirby-dropdown",3),r()()),t&2&&(c(),m("label","Label for medium dropdown")("message","Message"),c(),m("items",D(7,Nr)),c(),m("label","Label for small dropdown")("message","Message"),c(),m("size","sm")("items",D(8,Nr)))},dependencies:[J,A],styles:["kirby-card[_ngcontent-%COMP%]{margin-block:24px;max-width:fit-content}kirby-card[_ngcontent-%COMP%]   kirby-dropdown[_ngcontent-%COMP%] + kirby-dropdown[_ngcontent-%COMP%]{margin-top:16px}kirby-card.attention-levels[_ngcontent-%COMP%]{max-width:320px}p[_ngcontent-%COMP%]{margin-top:16px}.column-layout[_ngcontent-%COMP%]{display:flex;flex-flow:column wrap;gap:var(--kirby-spacing-m)}.constrain-width[_ngcontent-%COMP%]   kirby-dropdown[_ngcontent-%COMP%]{max-width:fit-content}"]});let i=e;return i})();var Zs={template:`<div class="message-type-container">
  <kirby-empty-state
    iconName="verify"
    themeColor="success"
    title="Success"
...
</kirby-list>`,c1=(()=>{let e=class e extends xt{constructor(){super(...arguments),this.template=jc}};e.\u0275fac=(()=>{let o;return function(a){return(o||(o=L(e)))(a||e)}})(),e.\u0275cmp=d({type:e,selectors:[["cookbook-simple-list-no-shape-example"]],features:[E],decls:2,vars:1,consts:[["shape","none",3,"items"],[4,"kirbyListItemTemplate"],[1,"kirby-text-normal-bold"],["slot","end",3,"value"]],template:function(t,a){t&1&&(n(0,"kirby-list",0),v(1,Uc,6,5,"kirby-item",1),r()),t&2&&m("items",a.items)},dependencies:[K,C,$,ct],encapsulation:2});let i=e;return i})();var Yc=()=>["Much cool","Such items","Wow"];function Qc(i,e){if(i&1&&(n(0,"kirby-item")(1,"p",3),s(2),r(),n(3,"data",4),s(4),X(5,"currency"),r()()),i&2){let l=e.$implicit;c(2),k(l.title),c(),m("value",l.amount),c(),k(se(5,3,l.amount))}}var Jc=`<kirby-card>
...
</kirby-list>`,H1=(()=>{let e=class e extends ie{constructor(){super(...arguments),this.template=mm}};e.\u0275fac=(()=>{let o;return function(a){return(o||(o=L(e)))(a||e)}})(),e.\u0275cmp=d({type:e,selectors:[["cookbook-list-with-header-and-footer-example"]],features:[E],decls:4,vars:1,consts:[[3,"itemSelect","items"],[4,"kirbyListHeader"],[3,"selectable",4,"kirbyListItemTemplate"],["class","footer",4,"kirbyListFooter"],[3,"selectable"],[1,"kirby-item-title"],[1,"kirby-item-subtitle"],["slot","end"],[3,"value"],[1,"kirby-item-detail",3,"value"],[1,"footer"],["kirby-button",""]],template:function(t,a){t&1&&(n(0,"kirby-list",0),b("itemSelect",function(h){return a.onItemSelect(h)}),v(1,lm,5,0,"kirby-list-header",1)(2,sm,11,7,"kirby-item",2)(3,cm,5,0,"div",3),r()),t&2&&m("items",a.items)},dependencies:[K,C,f,N,Cn,$,vn,xn],styles:["p[_ngcontent-%COMP%]{margin:0}",".footer[_ngcontent-%COMP%]{text-align:center;width:100%}"]});let i=e;return i})();function dm(i,e){if(i&1&&p(0,"kirby-list-section-header",3),i&2){let l=e.$implicit;m("title",l)}}function pm(i,e){if(i&1&&(n(0,"kirby-item",4)(1,"kirby-label")(2,"p",5),s(3),r(),n(4,"data",6),s(5),r()(),n(6,"kirby-label",7)(7,"data",8),s(8),r()()()),i&2){let l=e.$implicit;m("selectable",!0),c(3),k(l.title),c(),m("value",l.detail),c(),_(" ",l.detail),c(2),m("value",l.amount),c(),_(" ",l.amount)}}var um=`<kirby-list
  [items]="items"
  (itemSelect)="onItemSelect($event)"
...
</kirby-list>`,t_=(()=>{let e=class e extends ie{constructor(){super(...arguments),this.template=km}};e.\u0275fac=(()=>{let o;return function(a){return(o||(o=L(e)))(a||e)}})(),e.\u0275cmp=d({type:e,selectors:[["cookbook-list-selectable-items-example"]],features:[E],decls:2,vars:1,consts:[[3,"itemSelect","items"],[3,"selectable",4,"kirbyListItemTemplate"],[3,"selectable"],[1,"kirby-item-title"],["slot","end",1,"kirby-text-bold"]],template:function(t,a){t&1&&(n(0,"kirby-list",0),b("itemSelect",function(h){return a.onItemSelect(h)}),v(1,ym,5,3,"kirby-item",1),r()),t&2&&m("items",a.items)},dependencies:[K,C,$],encapsulation:2});let i=e;return i})();function fm(i,e){if(i&1&&(n(0,"kirby-item",2)(1,"kirby-label")(2,"p",3),s(3),r(),n(4,"data",4),s(5),r()(),n(6,"kirby-label",5)(7,"data",6),s(8),r()()()),i&2){let l=e.$implicit;m("selectable",!0),c(3),_(" ",l.title),c(),m("value",l.detail),c(),_(" ",l.detail),c(2),m("value",l.amount),c(),_(" ",l.amount)}}var Cm=`<kirby-list
  [items]="items"
  (itemSelect)="onItemSelect($event)"
  [getStandAloneByProperty]="'isStandAlone'"
  [standAloneSpacing]="'xxs'">
...
`},vt=class vt{constructor(e){this.modalController=e}async showModal(e){let l={component:bo,flavor:e,componentProps:{showStepper:!1}};await this.modalController.showModal(l)}};vt.template=Qr.template,vt.codeSnippet=Qr.codeSnippet,vt.\u0275fac=function(l){return new(l||vt)(x(ae))},vt.\u0275cmp=d({type:vt,selectors:[["cookbook-modal-example-alert"]],decls:2,vars:0,consts:[["kirby-button","","size","lg",3,"click"]],template:function(l,o){l&1&&(n(0,"button",0),b("click",function(){return o.showModal("modal")}),s(1,"Show modal (with alert)"),r())},dependencies:[f],styles:[".example-container[_ngcontent-%COMP%]{margin:32px auto;max-width:768px}.example-frame[_ngcontent-%COMP%]{position:relative;border:1px solid var(--kirby-medium);border-radius:12px;padding:32px}.example-frame.no-padding[_ngcontent-%COMP%]{padding:0}@media(max-width:767px){.example-frame[_ngcontent-%COMP%]{margin-inline:-16px;padding-inline:16px}}[_nghost-%COMP%]{display:block;height:100%;overflow-x:hidden;background:var(--kirby-background-color);padding-inline:24px;padding-block:16px;box-sizing:border-box}@media(min-width:768px){[_nghost-%COMP%]{padding:32px}}[_nghost-%COMP%]   h2[_ngcontent-%COMP%]:not(:first-child){margin-top:32px}[_nghost-%COMP%]   h3[_ngcontent-%COMP%]{margin-top:12px;margin-bottom:4px}[_nghost-%COMP%]{display:grid;place-content:center;overflow-y:auto}[_nghost-%COMP%] > button[_ngcontent-%COMP%]{min-width:15rem}kirby-card[_ngcontent-%COMP%]{margin-top:32px}kirby-card[_ngcontent-%COMP%]   kirby-card-header[_ngcontent-%COMP%]   em[_ngcontent-%COMP%]{font-size:smaller}cookbook-modal-example-size-selector[_ngcontent-%COMP%]{margin-bottom:24px}"]});var Jr=vt;function sd(i,e){i&1&&(n(0,"kirby-page-title"),s(1,"Modal Component"),r(),n(2,"p"),s(3," Lorem ipsum. "),r(),n(4,"kirby-modal-footer")(5,"button",7),s(6,"Button in footer"),r()())}function cd(i,e){i&1&&(n(0,"kirby-page-title"),s(1,"Modal Component"),r(),n(2,"p"),s(3," Lorem ipsum. "),r(),n(4,"kirby-modal-footer")(5,"button",7),s(6,"Button in footer"),r()())}function md(i,e){i&1&&p(0,"kirby-empty-state",8)}var Zr=`<ng-template>
    ...
    <kirby-empty-state
      ...
      themeColor="danger"
      ></kirby-empty-state>
  </ng-template>`,No={selector:"cookbook-modal-component-example",template:`<button kirby-button size="lg" id="open-modal">Show modal</button>
...
</kirby-page>`,$d=`<ng-template #controls>
  <kirby-card>
    <kirby-item>
      <h3>Show tabs</h3>
...
</ng-template>`,uS={template:aa+$d,styles:[`.close-footer-btn {
        position: absolute;
        top: 8px;
        right: 16px;
        margin: 0;
...
<kirby-radio-group>`},KT=(()=>{let e=class e{constructor(){this.template=Np.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-radio-sizes-example"]],decls:5,vars:0,consts:[["aria-label","Radio size example"],["size","xs","text","Extra Small"],["size","sm","text","Small"],["size","md","text","Medium (default)"]],template:function(t,a){t&1&&(n(0,"kirby-radio-group",0),p(1,"kirby-radio",1)(2,"kirby-radio",2)(3,"kirby-radio",3)(4,"kirby-radio-group"),r())},dependencies:[de,ve],styles:['kirby-checkbox[_ngcontent-%COMP%], kirby-radio[_ngcontent-%COMP%]{margin-bottom:8px;background-color:var(--kirby-semi-light);position:relative}kirby-checkbox[_ngcontent-%COMP%]:before, kirby-checkbox[_ngcontent-%COMP%]:after, kirby-radio[_ngcontent-%COMP%]:before, kirby-radio[_ngcontent-%COMP%]:after{height:100%;border:1px solid var(--kirby-danger);position:absolute;right:0}kirby-checkbox[_ngcontent-%COMP%]:before, kirby-radio[_ngcontent-%COMP%]:before{content:"";border-left:0;border-right:0;width:9px}kirby-checkbox[_ngcontent-%COMP%]:after, kirby-radio[_ngcontent-%COMP%]:after{content:"md: 56px";border-left:0;border-top:0;border-bottom:0;line-height:56px;font-size:12px;color:var(--kirby-danger);padding-right:8px;margin-right:4px;vertical-align:center}kirby-radio.xs[_ngcontent-%COMP%]:after{content:"xs: 32px";line-height:32px}kirby-radio.sm[_ngcontent-%COMP%]:after{content:"sm: 44px";line-height:44px}kirby-radio.md[_ngcontent-%COMP%]:after{content:"md: 56px";line-height:56px}kirby-checkbox.xs[_ngcontent-%COMP%]:after{content:"xs: 24px";line-height:24px}kirby-checkbox.sm[_ngcontent-%COMP%]:after{content:"sm: 44px";line-height:44px}kirby-checkbox.md[_ngcontent-%COMP%]:after{content:"md: 56px";line-height:56px}kirby-checkbox[_ngcontent-%COMP%]     ion-checkbox, kirby-radio[_ngcontent-%COMP%]     ion-radio{background-color:#f7e0f0;margin-right:80px}']});let i=e;return i})();var $p={selector:"cookbook-radio-multiline-example",template:`<kirby-radio
  text="Lorem ipsum dolor sit amet, consectetur adipiscing elit,&#10; sed do eiusmod tempor incididunt ut labore et dolore &#10; magna aliqua.">
</kirby-radio>`},VT=(()=>{let e=class e{constructor(){this.template=$p.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-radio-multiline-example"]],decls:1,vars:0,consts:[["text",`Lorem ipsum dolor sit amet, consectetur adipiscing elit,
 sed do eiusmod tempor incididunt ut labore et dolore 
...
</kirby-menu>`},rP=(()=>{let e=class e{constructor(){this.template=pu.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-menu-advanced-example"]],decls:16,vars:1,consts:[["aria-label","Advanced items",3,"closeOnSelect"],["name","person","slot","start"],["slot","end"],["name","notification","slot","start"],["name","default","slot","start"]],template:function(t,a){t&1&&(n(0,"kirby-menu",0)(1,"kirby-item"),p(2,"kirby-icon",1),n(3,"kirby-checkbox",2)(4,"kirby-label"),s(5," Friend Throw "),r()()(),n(6,"kirby-item"),p(7,"kirby-icon",3),n(8,"kirby-checkbox",2)(9,"kirby-label"),s(10," Ice Curling "),r()()(),n(11,"kirby-item"),p(12,"kirby-icon",4),n(13,"kirby-toggle",2)(14,"kirby-label"),s(15," Allow Cheats "),r()()()()),t&2&&m("closeOnSelect",!1)},dependencies:[$e,C,w,B,Be,N],encapsulation:2});let i=e;return i})();var uu={selector:"cookbook-menu-custom-button-example",template:`<kirby-menu aria-label="Custom button">
  <button
    kirby-button
    type="button"
    [attentionLevel]="'3'"
...
</kirby-menu>`},dP=(()=>{let e=class e{constructor(){this.template=uu.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-menu-custom-button-example"]],decls:12,vars:2,consts:[["aria-label","Custom button"],["kirby-button","","type","button",3,"attentionLevel"],[3,"name"],[1,"kirby-item-title"]],template:function(t,a){t&1&&(n(0,"kirby-menu",0)(1,"button",1),p(2,"kirby-icon",2),r(),n(3,"kirby-item")(4,"p",3),s(5,"Stone"),r()(),n(6,"kirby-item")(7,"p",3),s(8,"Rick"),r()(),n(9,"kirby-item")(10,"p",3),s(11,"Gooey"),r()()()),t&2&&(c(),m("attentionLevel","3"),c(),m("name","menu-outline"))},dependencies:[$e,f,w,C],encapsulation:2});let i=e;return i})();var bu={selector:"cookbook-menu-portal-example",template:`<kirby-menu 
...
`},gP=(()=>{let e=class e{constructor(o){this.cd=o,this.template=bu.template,this.outletTag="cookbook-root",this.outletElement=this.getOutletElement()}set isOutletElementSet(o){this._outlet=o?this.outletElement:null}getOutletElement(){let o=document.getElementsByTagName(this.outletTag);if(!o||o.length===0)throw Error(`Could not locate HTMLElement for ${this.outletTag}. Did you misspell it?`);if(o.length>1)throw Error(`Multiple HTMLElements found for ${this.outletTag}.
      This can lead to unintended behaviours. Provide an unique outlet`);return o[0]}};e.\u0275fac=function(t){return new(t||e)(x(Mi))},e.\u0275cmp=d({type:e,selectors:[["cookbook-menu-portal-example"]],inputs:{isOutletElementSet:"isOutletElementSet"},decls:10,vars:1,consts:[[3,"DOMPortalOutlet"],[1,"kirby-item-title"]],template:function(t,a){t&1&&(n(0,"kirby-menu",0)(1,"kirby-item")(2,"p",1),s(3,"Stone"),r()(),n(4,"kirby-item")(5,"p",1),s(6,"Rick"),r()(),n(7,"kirby-item")(8,"p",1),s(9,"Gooey"),r()()()),t&2&&m("DOMPortalOutlet",a._outlet)},dependencies:[$e,C],encapsulation:2});let i=e;return i})();var gu={selector:"cookbook-menu-portal-config-example",template:`<kirby-menu [portalOutletConfig]="outletConfig">
  <kirby-item>
    <p class="kirby-item-title">Stone</p>
  </kirby-item>
  <kirby-item>
  ...
  <kirby-item>
    ...
    value: 'cookbook-root',
  };`},CP=(()=>{let e=class e{constructor(){this.template=gu.template,this.outletConfig={selector:Pn.tag,value:"cookbook-root"}}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-menu-portal-config-example"]],decls:10,vars:1,consts:[[3,"portalOutletConfig"],[1,"kirby-item-title"]],template:function(t,a){t&1&&(n(0,"kirby-menu",0)(1,"kirby-item")(2,"p",1),s(3,"Stone"),r()(),n(4,"kirby-item")(5,"p",1),s(6,"Rick"),r()(),n(7,"kirby-item")(8,"p",1),s(9,"Gooey"),r()()()),t&2&&m("portalOutletConfig",a.outletConfig)},dependencies:[$e,C],encapsulation:2});let i=e;return i})();var hu={selector:"cookbook-label-example-direction",template:`<kirby-item>
  <kirby-label>
    <p class="kirby-item-title">Title</p>
    <p class="kirby-item-detail">Detail</p>
  </kirby-label>
...
</kirby-item>`},_P=(()=>{let e=class e{constructor(){this.template=hu.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-label-example-direction"]],decls:15,vars:0,consts:[[1,"kirby-item-title"],[1,"kirby-item-detail"],["direction","horizontal"]],template:function(t,a){t&1&&(n(0,"kirby-item")(1,"kirby-label")(2,"p",0),s(3,"Title"),r(),n(4,"p",1),s(5,"Detail"),r()()(),n(6,"kirby-item")(7,"kirby-label")(8,"kirby-label",2)(9,"p",0),s(10,"Title"),r(),n(11,"p",1),s(12,"Detail"),r()(),n(13,"p"),s(14,"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut non neque vitae felis ultricies imperdiet in ut orci."),r()()())},dependencies:[C,N],styles:["kirby-item[_ngcontent-%COMP%]:not(:last-child){margin-bottom:var(--kirby-spacing-xxs)}"]});let i=e;return i})();export{ku as a,Mu as b,Pu as c,Lu as d,Nu as e,qu as f,Wu as g,Ju as h,ib as i,D0 as j,A0 as k,$0 as l,ie as m,j0 as n,ig as o,ag as p,mg as q,ug as r,kr as s,vg as t,Tg as u,Dg as v,Lg as w,Ng as x,Kg as y,Vg as z,jg as A,Jg as B,eh as C,nh as D,lh as E,mh as F,hh as G,fh as H,vh as I,Mh as J,Dh as K,Ah as L,Nh as M,qh as N,Wh as O,Gh as P,ey as Q,Ce as R,my as S,uy as T,hy as U,vy as V,My as W,Py as X,Fy as Y,zy as Z,$y as _,Ky as $,Vy as aa,jy as ba,Zy as ca,ik as da,rk as ea,sk as fa,pk as ga,gk as ha,kk as ia,_k as ja,Mk as ka,Dk as la,Fk as ma,zk as na,Ke as oa,qk as pa,Gk as qa,Qk as ra,tf as sa,rf as ta,sf as ua,df as va,bf as wa,yf as xa,vf as ya,Sf as za,If as Aa,$f as Ba,Kf as Ca,Gf as Da,Qf as Ea,eC as Fa,nC as Ga,mC as Ha,uC as Ia,hC as Ja,SC as Ka,PC as La,LC as Ma,$C as Na,RC as Oa,YC as Pa,XC as Qa,cx as Ra,ux as Sa,yx as Ta,vx as Ua,Mx as Va,Dx as Wa,Ax as Xa,Hx as Ya,Rx as Za,Gx as _a,Yx as $a,ov as ab,av as bb,Hr as cb,qr as db,Rr as eb,vv as fb,Tv as gb,Iv as hb,Lv as ib,Bv as jb,Rv as kb,Yv as lb,t1 as mb,i1 as nb,c1 as ob,y1 as pb,w1 as qb,P1 as rb,A1 as sb,H1 as tb,V1 as ub,Q1 as vb,t_ as wb,a_ as xb,m_ as yb,b_ as zb,Gr as Ab,Ur as Bb,jr as Cb,Yr as Db,bo as Eb,Jr as Fb,Xr as Gb,ta as Hb,ia as Ib,oa as Jb,na as Kb,ra as Lb,la as Mb,sa as Nb,ca as Ob,da as Pb,pa as Qb,$S as Rb,KS as Sb,VS as Tb,JS as Ub,e2 as Vb,n2 as Wb,d2 as Xb,b2 as Yb,y2 as Zb,C2 as _b,S2 as $b,D2 as ac,L2 as bc,q2 as cc,U2 as dc,J2 as ec,eM as fc,aM as gc,cM as hc,gM as ic,xM as jc,wM as kc,TM as lc,OM as mc,LM as nc,$M as oc,ha as pc,GM as qc,QM as rc,eT as sc,oT as tc,fa as uc,Ca as vc,xa as wc,pT as xc,gT as yc,kT as zc,wT as Ac,TT as Bc,zT as Cc,$T as Dc,KT as Ec,VT as Fc,YT as Gc,e3 as Hc,n3 as Ic,m3 as Jc,f3 as Kc,E3 as Lc,O3 as Mc,A3 as Nc,N3 as Oc,K3 as Pc,V3 as Qc,Q3 as Rc,oE as Sc,lE as Tc,dE as Uc,xE as Vc,La as Wc,za as Xc,Ba as Yc,Na as Zc,ZE as _c,rP as $c,dP as ad,gP as bd,CP as cd,_P as dd};
