...
`;var Lt=function(i,e,l,o){var t=arguments.length,a=t<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,l):o,g;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(i,e,l,o);else for(var h=i.length-1;h>=0;h--)(g=i[h])&&(a=(t<3?g(a):t>3?g(e,l,a):g(e,l))||a);return t>3&&a&&Object.defineProperty(e,l,a),a},mr=0,dr=(()=>{let e=class e extends so{constructor(){super(...arguments),this.title="",this.isExpanded=!1,this.isDisabled=!1,this.disabledTitle="",this.hasPadding=!0,this.shape="none",this._titleId=`kirby-accordion-item-title-${++mr}`,this._contentId=`kirby-accordion-item-content-${mr}`}getTitle(){return this.isDisabled&&this.disabledTitle?this.disabledTitle:this.title}_onToggleExpanded(o){o.preventDefault(),!this.isDisabled&&(this.isExpanded=!this.isExpanded,this.dispatchEvent(new CustomEvent("toggle",{detail:this.isExpanded,bubbles:!0,composed:!0})))}connectedCallback(){super.connectedCallback(),this.closest("kirby-card")&&this.classList.add("in-card")}firstUpdated(){let o=this.renderRoot.querySelector("slot");o&&o.addEventListener("slotchange",()=>{o.assignedElements({flatten:!0}).forEach(a=>{a.tagName==="KIRBY-LIST"&&a.setAttribute("shape","none")})})}updated(o){o.has("isDisabled")&&this.isDisabled&&(this.isExpanded=!1)}render(){return rr`
...
didDismiss() {
  this.isOpen = false;
        ...
        <p>Alias aspernatur consequuntur debitis delectus ducimus, enim eveniet inventore laudantium libero molestiae
            ...
            nesciunt quas recusandae saepe soluta tempore velit, vitae! Aperiam distinctio exercitationem id incidunt
            ipsa repellendus similique sunt vero.</p>
        <p class="kirby-text-medium">THE END</p>`}};var Qr=()=>({fixed:!0});function sd(i,e){i&1&&je(0)}function cd(i,e){if(i&1&&(n(0,"div")(1,"span",9),v(2,sd,1,0,"ng-container",10),r()()),i&2){y();let l=ee(5);c(2),m("ngTemplateOutlet",l)}}function md(i,e){i&1&&(n(0,"div"),s(1," Custom subtitle with a long long long long name "),r())}function dd(i,e){i&1&&je(0)}function pd(i,e){if(i&1&&v(0,dd,1,0,"ng-container",10),i&2){y();let l=ee(5);m("ngTemplateOutlet",l)}}function ud(i,e){i&1&&s(0," Custom Title with a very long name ")}function bd(i,e){i&1&&s(0," Custom subtitle of custom title with a very long name ")}function gd(i,e){if(i&1){let l=P();n(0,"kirby-page-actions")(1,"button",11),b("click",function(){S(l);let t=y();return M(t.onMoreSelect())}),p(2,"kirby-icon",12),r()()}}function hd(i,e){if(i&1){let l=P();n(0,"kirby-page-actions")(1,"button",13),b("click",function(){S(l);let t=y();return M(t.onCogSelect())}),p(2,"kirby-icon",14),r()()}}function yd(i,e){if(i&1&&p(0,"div",15),i&2){let l=y();m("innerHTML",l.content,Y)}}function kd(i,e){if(i&1){let l=P();n(0,"kirby-fab-sheet",16),p(1,"kirby-icon",17),n(2,"kirby-action-sheet",18),b("itemSelect",function(t){S(l);let a=y();return M(a.onItemSelect(t))}),r()()}if(i&2){let l=y();c(2),m("items",l.items)}}var fd={template:`<kirby-page defaultBackHref="/">
