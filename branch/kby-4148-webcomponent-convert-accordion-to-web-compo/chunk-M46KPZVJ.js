...
`;var Lt=function(i,e,l,o){var t=arguments.length,a=t<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,l):o,g;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(i,e,l,o);else for(var h=i.length-1;h>=0;h--)(g=i[h])&&(a=(t<3?g(a):t>3?g(e,l,a):g(e,l))||a);return t>3&&a&&Object.defineProperty(e,l,a),a},br=0,gr=(()=>{let e=class e extends co{constructor(){super(...arguments),this.itemTitle="",this.isExpanded=!1,this.isDisabled=!1,this.disabledTitle="",this.hasPadding=!0,this.shape="none",this._titleId=`kirby-accordion-item-title-${++br}`,this._contentId=`kirby-accordion-item-content-${br}`}getTitle(){return this.isDisabled&&this.disabledTitle?this.disabledTitle:this.itemTitle}_onToggleExpanded(o){o.preventDefault(),!this.isDisabled&&(this.isExpanded=!this.isExpanded,this.dispatchEvent(new CustomEvent("toggle",{detail:this.isExpanded,bubbles:!0,composed:!0})))}connectedCallback(){super.connectedCallback(),this.closest("kirby-card")&&this.classList.add("in-card")}firstUpdated(){let o=this.renderRoot.querySelector("slot");o&&o.addEventListener("slotchange",()=>{o.assignedElements({flatten:!0}).forEach(a=>{a.tagName==="KIRBY-LIST"&&a.setAttribute("shape","none")})})}updated(o){o.has("isDisabled")&&this.isDisabled&&(this.isExpanded=!1)}render(){return ar`
