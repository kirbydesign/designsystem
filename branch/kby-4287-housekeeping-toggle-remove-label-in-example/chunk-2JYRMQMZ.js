...
`},n2=(()=>{let e=class e{constructor(){this.template=md.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-toggle-state-example"]],decls:3,vars:0,consts:[["slot","end","aria-label","Default toggle"],["checked","true","slot","end","aria-label","Checked toggle"],["disabled","true","slot","end","aria-label","Disabled toggle"]],template:function(t,a){t&1&&p(0,"kirby-toggle",0)(1,"kirby-toggle",1)(2,"kirby-toggle",2)},dependencies:[Te],styles:["[_nghost-%COMP%]{display:flex;flex-direction:column;gap:var(--kirby-spacing-s)}"]});let i=e;return i})();var dd={selector:"cookbook-radio-states-example",template:`<kirby-radio-group aria-label="Radio state example">
