...
</div>`,htmlSnippet:`<kirby-toggle>Default</kirby-toggle>
<kirby-toggle checked="true" (checkedChange)="onCheckedChange($event)">Checked</kirby-toggle>
<kirby-toggle disabled="true">Disabled</kirby-toggle>`},y2=(()=>{let e=class e{constructor(){this.htmlSnippet=ed.htmlSnippet}onCheckedChange(r){console.log(`Toggle onCheckedChange: ${r}`)}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-toggle-default-example"]],decls:15,vars:0,consts:[[1,"toggle-item-container"],[1,"toggle-item-inner-container"],[1,"toggle-item-title"],["checked","true",3,"checkedChange"],["disabled","true"]],template:function(t,a){t&1&&(o(0,"div",0)(1,"div",1),p(2,"kirby-toggle"),n(),o(3,"span",2),l(4,"Default"),n()(),o(5,"div",0)(6,"div",1)(7,"kirby-toggle",3),u("checkedChange",function(f){return a.onCheckedChange(f)}),n()(),o(8,"span",2),l(9,"Checked"),n()(),o(10,"div",0)(11,"div",1),p(12,"kirby-toggle",4),n(),o(13,"span",2),l(14,"Disabled"),n()())},dependencies:[Ie],styles:["[_nghost-%COMP%]{display:flex;flex-direction:column;gap:16px}@media(min-width:768px){[_nghost-%COMP%]{flex-direction:row;gap:40px}}.toggle-item-inner-container[_ngcontent-%COMP%]{align-items:center;justify-content:center;width:100%;flex-wrap:wrap;margin-bottom:8px}.toggle-item-title[_ngcontent-%COMP%]{display:block;max-width:96px;font-size:12px;color:#0009;white-space:nowrap}.toggle-item-container[_ngcontent-%COMP%]{display:inline-block;text-align:center}"]});let i=e;return i})();var tr={selector:"cookbook-toggle-reactive-forms-example",template:`<form [formGroup]="form">
  <kirby-item>
    <kirby-toggle
      slot="end"
