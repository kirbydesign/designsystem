...
</kirby-avatar>`},su=(()=>{let e=class e{constructor(){this.template=Br.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-avatar-example-default"]],decls:2,vars:0,consts:[["name","kirby"]],template:function(t,a){t&1&&(o(0,"kirby-avatar"),p(1,"kirby-icon",0),n())},dependencies:[G,w],styles:['[_nghost-%COMP%]{display:flex;align-items:flex-end;margin-bottom:12px}[_nghost-%COMP%] > *[_ngcontent-%COMP%]{margin-right:16px}.wrap[_nghost-%COMP%]{flex-wrap:wrap}.align-top[_nghost-%COMP%]{align-items:flex-start}kirby-avatar[_ngcontent-%COMP%]{margin-bottom:16px;position:relative}kirby-avatar[_ngcontent-%COMP%]:before{content:"";width:100%;position:absolute;bottom:0;transform:translateY(100%);font-size:12px;text-align:center;display:inline-block;padding-top:4px}kirby-avatar[stroke][stroke=true][_ngcontent-%COMP%]:before{content:"Stroke"}kirby-avatar[overlay][overlay=true][_ngcontent-%COMP%]:before{content:"Overlay"}kirby-avatar[themeColor][themeColor=light][_ngcontent-%COMP%]:before{content:"Light";padding-top:24px;margin-bottom:16px}kirby-avatar[themeColor][themeColor=white][_ngcontent-%COMP%]:before{content:"White";padding-top:24px;margin-bottom:16px}.avatar-item-inner-container-bg[_ngcontent-%COMP%]{background-color:var(--kirby-white);padding:12px;border-radius:16px;margin-bottom:8px}.avatar-item-inner-container-bg-none[_ngcontent-%COMP%]{padding:12px;border-radius:16px;margin-bottom:8px}']});let i=e;return i})();var Jo={selector:"cookbook-avatar-example-colors",template:`<div class="avatar-item-container">
