...
}`]},PS=(()=>{let e=class e{constructor(){this.template=`<!-- 1. Using slotted <kirby-radio> -->
${Ei.slottedTemplate}
...
favoriteRequired = true;`},o2=(()=>{let e=class e{constructor(){this.template=or.template.split("<cookbook-example-configuration-wrapper>")[0],this.codeSnippet=or.codeSnippet,this.items=nr,this.selected=null,this.canSelectFavorite=!0,this.favoriteRequired=!0}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-radio-template-driven-forms-example"]],decls:30,vars:24,consts:[["group","ngModel"],[3,"ngModelChange","items","ngModel","required","disabled"],["text","Form field enabled","size","xs",3,"checkedChange","checked"],["text","Form field required","size","xs",3,"checkedChange","checked"],["kirby-button","","size","sm","attentionLevel","2",3,"click","disabled"],[1,"form-state"]],template:function(t,a){if(t&1){let g=P();o(0,"kirby-radio-group",1,0),De("ngModelChange",function(Ve){return x(g),H(a.selected,Ve)||(a.selected=Ve),v(Ve)}),n(),o(2,"cookbook-example-configuration-wrapper")(3,"kirby-checkbox",2),b("checkedChange",function(){return x(g),v(a.canSelectFavorite=!a.canSelectFavorite)}),n(),o(4,"kirby-checkbox",3),b("checkedChange",function(){return x(g),v(a.favoriteRequired=!a.favoriteRequired)}),n(),o(5,"button",4),b("click",function(){return x(g),v(a.selected=null)}),l(6," Clear selection "),n(),o(7,"section",5)(8,"h4"),l(9,"Form state:"),n(),o(10,"p")(11,"strong"),l(12,"Selected:"),n(),l(13),Z(14,"json"),n(),o(15,"p")(16,"strong"),l(17,"ngModel: "),n(),o(18,"span"),l(19),n(),o(20,"span"),l(21),n(),o(22,"span"),l(23),n()(),o(24,"p")(25,"strong"),l(26,"ngModel.errors: "),n(),o(27,"span"),l(28),Z(29,"json"),n()()()()}if(t&2){let g=X(1);m("items",a.items),Pe("ngModel",a.selected),m("required",a.favoriteRequired)("disabled",a.canSelectFavorite?null:!0),c(3),m("checked",a.canSelectFavorite),c(),m("checked",a.favoriteRequired),c(),m("disabled",a.selected===null),c(8),S(" ",re(14,20,a.selected)," "),c(5),G("state-true",g.valid),c(),S("valid: ",g.valid),c(),G("state-true",g.enabled),c(),S("enabled: ",g.enabled),c(),G("state-true",g.touched),c(),S("touched: ",g.touched),c(4),G("state-true",!g.errors),c(),k(re(29,22,g.errors))}},dependencies:[le,ye,ue,po,Jt,ge,A,C,Je],styles:["[_nghost-%COMP%]{display:flex}cookbook-example-configuration-wrapper[_ngcontent-%COMP%]{margin-left:8px}@media(min-width:768px){cookbook-example-configuration-wrapper[_ngcontent-%COMP%]{margin-left:40px}}.form-state[_ngcontent-%COMP%]{margin-top:12px;border-top:1px solid var(--kirby-medium);padding:8px}.form-state[_ngcontent-%COMP%]   h4[_ngcontent-%COMP%]{margin-bottom:4px;font-weight:400}.form-state[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{margin:0;font-size:.75rem;line-height:1.3334}.form-state[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]{background-color:var(--kirby-danger);color:var(--kirby-white);margin-right:4px;padding:0 2px;border-radius:4px}.form-state[_ngcontent-%COMP%]   span.state-true[_ngcontent-%COMP%]{background-color:var(--kirby-success);color:var(--kirby-success-contrast)}"]});let i=e;return i})();var Jm={selector:"cookbook-header-example-default",template:`<kirby-header [title]="'Title'" subtitle1="Subtitle one" subtitle2="Subtitle two">
  ...
  <div class="custom-flag" *kirbyHeaderCustomFlag>
    ...
    align-items: center;
    gap: 6px;
}`]},k2=(()=>{let e=class e{constructor(){this.template=rr.template,this.styles=rr.styles.join(`
...
}`]},q2=(()=>{let e=class e{constructor(){this.template=Pi.template,this.styles=Pi.styles.join(`
...
</kirby-header>`,styles:Pi.styles},Q2=(()=>{let e=class e{constructor(r){this.toastController=r,this.template=ar.template,this.styles=ar.styles.join(`
