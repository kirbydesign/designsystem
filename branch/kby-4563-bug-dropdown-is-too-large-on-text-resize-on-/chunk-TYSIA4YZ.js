...
`},Wy=(()=>{let e=class e{constructor(){this.template=fl.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-dropdown-example-form-field"]],decls:4,vars:9,consts:[[3,"label","message"],["placeholder","Dropdown in form field",3,"items"],["placeholder","Dropdown in form field",3,"size","items"]],template:function(t,a){t&1&&(o(0,"kirby-form-field",0),p(1,"kirby-dropdown",1),n(),o(2,"kirby-form-field",0),p(3,"kirby-dropdown",2),n()),t&2&&(m("label","Label for medium dropdown")("message","Message"),c(),m("items",D(7,Cn)),c(),m("label","Label for small dropdown")("message","Message"),c(),m("size","sm")("items",D(8,Cn)))},dependencies:[Q,F],styles:["kirby-card[_ngcontent-%COMP%]{margin-block:var(--kirby-spacing-m);max-width:fit-content}kirby-card[_ngcontent-%COMP%]   kirby-dropdown[_ngcontent-%COMP%] + kirby-dropdown[_ngcontent-%COMP%]{margin-top:var(--kirby-spacing-s)}kirby-card.attention-levels[_ngcontent-%COMP%]{max-width:320px}p[_ngcontent-%COMP%]{margin-top:var(--kirby-spacing-s)}.column-layout[_ngcontent-%COMP%]{display:flex;flex-flow:column wrap;gap:var(--kirby-spacing-m)}.constrain-width[_ngcontent-%COMP%]{align-items:flex-start}"]});let i=e;return i})();var hl={template:`<div class="message-type-container">
  <kirby-empty-state
    iconName="verify"
    themeColor="success"
    title="Success"
