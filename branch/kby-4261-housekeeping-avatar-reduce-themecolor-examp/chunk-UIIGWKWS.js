...
`),n(),o(8,"button",0),u("click",function(){return r.showAlertWithNewline()}),l(9,"Show alert with newline"),n(),o(10,"button",0),u("click",function(){return r.showAlertWithDynamicValues()}),l(11,"Show alert with dynamic values"),n())},dependencies:[h],styles:["[_nghost-%COMP%]{display:block}"]});var Qo=Re;var zr={selector:"cookbook-avatar-example-default",template:`<kirby-avatar size="xs">  <kirby-icon name="kirby"></kirby-icon></kirby-avatar>
...
></kirby-dropdown>`,styles:[`:host(.right-align) {
  ...
  margin-left: auto;
}`]},ay=(()=>{let e=class e{constructor(){this.template=bn.template,this.styles=bn.styles.join(`
