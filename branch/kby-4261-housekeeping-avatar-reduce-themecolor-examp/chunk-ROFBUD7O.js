...
<kirby-segmented-control
  ...
  mode="compactChip"
  size="sm"
></kirby-segmented-control>`,codeSnippetChipItems:"chipItems = [...'123456'].map((i) => ({ text: `Chip-${i}`, id: i }));",codeSnippetCompactChipItems:"compactChipItems = [...'12345678'].map((i) => ({ text: `c${i}`, id: i }));"},K_=(()=>{let e=class e{constructor(){this.template=Vi.template,this.codeSnippet=Vi.codeSnippetChipItems+`
...
onSegmentSelect(segment: SegmentItem) {
  this.selectedSegment = segment;
}`},G_=(()=>{let e=class e{constructor(){this.template=Wi.template,this.styles=`@use '@kirbydesign/core/src/scss/utils';
...
</kirby-item>`},sT=(()=>{let e=class e{constructor(){this.template=Fd.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-label-example-direction"]],decls:15,vars:0,consts:[[1,"kirby-item-title"],[1,"kirby-item-detail"],["direction","horizontal"]],template:function(t,a){t&1&&(o(0,"kirby-item")(1,"kirby-label")(2,"p",0),l(3,"Title"),n(),o(4,"p",1),l(5,"Detail"),n()()(),o(6,"kirby-item")(7,"kirby-label")(8,"kirby-label",2)(9,"p",0),l(10,"Title"),n(),o(11,"p",1),l(12,"Detail"),n()(),o(13,"p"),l(14,"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut non neque vitae felis ultricies imperdiet in ut orci."),n()()())},dependencies:[C,B],styles:["kirby-item[_ngcontent-%COMP%]:not(:last-child){margin-bottom:var(--kirby-spacing-xxs)}"]});let i=e;return i})();export{Ad as a,Wd as b,$d as c,Zd as d,tp as e,np as f,lp as g,bp as h,hp as i,vp as j,Sp as k,Pp as l,te as m,Bp as n,Rp as o,jp as p,Qp as q,Xp as r,Qo as s,su as t,uu as u,yu as v,xu as w,wu as x,Tu as y,Du as z,Fu as A,zu as B,Ku as C,Wu as D,$u as E,Uu as F,tb as G,nb as H,lb as I,db as J,gb as K,hb as L,_b as M,Mb as N,Pb as O,Ob as P,Kb as Q,ge as R,Ub as S,Zb as T,t0 as U,l0 as V,d0 as W,b0 as X,f0 as Y,x0 as Z,w0 as _,T0 as $,D0 as aa,F0 as ba,B0 as ca,H0 as da,R0 as ea,j0 as fa,J0 as ga,eg as ha,og as ia,sg as ja,dg as ka,gg as la,fg as ma,xg as na,Be as oa,Mg as pa,Og as qa,Ag as ra,qg as sa,Wg as ta,$g as ua,Ug as va,Zg as wa,ty as xa,ay as ya,cy as za,yy as Aa,_y as Ba,My as Ca,Dy as Da,Ly as Ea,Ny as Fa,Vy as Ga,Yy as Ha,Jy as Ia,ek as Ja,ck as Ka,uk as La,hk as Ma,_k as Na,Tk as Oa,Fk as Pa,Bk as Qa,jk as Ra,Jk as Sa,tf as Ta,lf as Ua,df as Va,gf as Wa,hf as Xa,Sf as Ya,Ef as Za,Of as _a,Lf as $a,Vf as ab,Gf as bb,fn as cb,hn as db,xn as eb,lh as fb,ph as gb,kh as hb,Ch as ib,vh as jb,Eh as kb,Lh as lb,qh as mb,Hh as nb,Yh as ob,iC as pb,cC as qb,bC as rb,hC as sb,SC as tb,DC as ub,AC as vb,qC as wb,GC as xb,UC as yb,XC as zb,wn as Ab,Sn as Bb,Mn as Cb,Tn as Db,Pi as Eb,Pn as Fb,On as Gb,Fn as Hb,Ln as Ib,An as Jb,zn as Kb,Bn as Lb,Kn as Mb,qn as Nb,Hn as Ob,Wn as Pb,Rn as Qb,w1 as Rb,T1 as Sb,D1 as Tb,z1 as Ub,K1 as Vb,W1 as Wb,Q1 as Xb,X1 as Yb,i_ as Zb,r_ as _b,m_ as $b,g_ as ac,C_ as bc,M_ as cc,I_ as dc,z_ as ec,K_ as fc,G_ as gc,Y_ as hc,ew as ic,aw as jc,cw as kc,pw as lc,yw as mc,Cw as nc,ww as oc,Yn as pc,Ow as qc,Aw as rc,Kw as sc,Vw as tc,Jn as uc,Zn as vc,Xn as wc,Jw as xc,e2 as yc,o2 as zc,c2 as Ac,p2 as Bc,x2 as Cc,w2 as Dc,T2 as Ec,D2 as Fc,L2 as Gc,K2 as Hc,W2 as Ic,U2 as Jc,nS as Kc,uS as Lc,yS as Mc,hS as Nc,_S as Oc,TS as Pc,DS as Qc,AS as Rc,VS as Sc,$S as Tc,QS as Uc,aM as Vc,ur as Wc,br as Xc,gr as Yc,yr as Zc,BM as _c,RM as $c,QM as ad,eT as bd,rT as cd,sT as dd};
