...
}`]},Wd=(()=>{let e=class e{constructor(){this.template=Ro.template,this.styles=Ro.styles[0]}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-item-example-slots"]],decls:11,vars:0,consts:[["slot","outside","themeColor","warning","size","sm"],["slot","start","themeColor","light"],["name","person"],[1,"kirby-item-title"],[1,"kirby-item-detail"],["slot","end","themeColor","success"]],template:function(t,a){t&1&&(o(0,"kirby-item"),p(1,"kirby-badge",0),o(2,"kirby-avatar",1),p(3,"kirby-icon",2),n(),o(4,"kirby-label")(5,"p",3),l(6,"Title"),n(),o(7,"p",4),l(8,"Detail"),n()(),o(9,"kirby-flag",5),l(10,"60"),n()())},dependencies:[h,ae,Fe,V,M,z],styles:["div[slot=outside][_ngcontent-%COMP%]{display:flex;flex-direction:column}"]});let i=e;return i})();var yr={selector:"cookbook-item-example-selectable",template:`
...
<kirby-item href="https://github.com/kirbydesign/designsystem" disclosure="link" target="_blank">
  <p class="kirby-item-title">Link with disclosure</p>
</kirby-item></kirby-card>`},jd=(()=>{let e=class e{constructor(){this.template=yr.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-item-example-selectable"]],decls:19,vars:4,consts:[[3,"selectable"],[1,"kirby-item-title"],["disclosure","arrow-more",3,"selectable"],["href","https://github.com/kirbydesign/designsystem","disclosure","link","target","_blank"]],template:function(t,a){t&1&&(o(0,"kirby-item",0)(1,"p",1),l(2,"Selectable"),n()(),o(3,"kirby-item",2)(4,"p",1),l(5,"Selectable with disclosure"),n()(),o(6,"kirby-item",3)(7,"p",1),l(8,"Link with disclosure"),n()(),o(9,"kirby-card")(10,"kirby-item",0)(11,"p",1),l(12,"Selectable"),n()(),o(13,"kirby-item",2)(14,"p",1),l(15,"Selectable with disclosure"),n()(),o(16,"kirby-item",3)(17,"p",1),l(18,"Link with disclosure"),n()()()),t&2&&(m("selectable",!0),c(3),m("selectable",!0),c(7),m("selectable",!0),c(3),m("selectable",!0))},dependencies:[h,T],styles:["kirby-item[_ngcontent-%COMP%]:not(:last-child){margin-bottom:var(--kirby-spacing-xxs)}"]});let i=e;return i})();var kr={selector:"cookbook-item-example-text-vertically-stacked",template:`<kirby-item>
  <kirby-label>
    <p class="kirby-item-title">Title</p>
...
></kirby-dropdown>`,styles:[`:host(.right-align) {
  ...
  margin-left: auto;
}`]},Qg=(()=>{let e=class e{constructor(){this.template=dn.template,this.styles=dn.styles.join(`
...
</ng-template>`,Jv={template:An+Zc,styles:[`.close-footer-btn {
        position: absolute;
        top: 8px;
        right: 16px;
        margin: 0;
...
<kirby-segmented-control
  ...
  mode="compactChip"
  size="sm"
></kirby-segmented-control>`,codeSnippetChipItems:"chipItems = [...'123456'].map((i) => ({ text: `Chip-${i}`, id: i }));",codeSnippetCompactChipItems:"compactChipItems = [...'12345678'].map((i) => ({ text: `c${i}`, id: i }));"},N_=(()=>{let e=class e{constructor(){this.template=Ki.template,this.codeSnippet=Ki.codeSnippetChipItems+`
...
onSegmentSelect(segment: SegmentItem) {
  this.selectedSegment = segment;
}`},R_=(()=>{let e=class e{constructor(){this.template=qi.template,this.styles=`@use '@kirbydesign/core/src/scss/utils';
...
}`]},A2=(()=>{let e=class e{constructor(){this.template=`<!-- 1. Using slotted <kirby-radio> -->
${Pi.slottedTemplate}
...
favoriteRequired = true;`},cS=(()=>{let e=class e{constructor(){this.template=nr.template.split("<cookbook-example-configuration-wrapper>")[0],this.codeSnippet=nr.codeSnippet,this.items=rr,this.selected=null,this.canSelectFavorite=!0,this.favoriteRequired=!0}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-radio-template-driven-forms-example"]],decls:30,vars:24,consts:[["group","ngModel"],[3,"ngModelChange","items","ngModel","required","disabled"],["text","Form field enabled","size","xs",3,"checkedChange","checked"],["text","Form field required","size","xs",3,"checkedChange","checked"],["kirby-button","","size","sm","attentionLevel","2",3,"click","disabled"],[1,"form-state"]],template:function(t,a){if(t&1){let g=P();o(0,"kirby-radio-group",1,0),De("ngModelChange",function(We){return x(g),q(a.selected,We)||(a.selected=We),v(We)}),n(),o(2,"cookbook-example-configuration-wrapper")(3,"kirby-checkbox",2),b("checkedChange",function(){return x(g),v(a.canSelectFavorite=!a.canSelectFavorite)}),n(),o(4,"kirby-checkbox",3),b("checkedChange",function(){return x(g),v(a.favoriteRequired=!a.favoriteRequired)}),n(),o(5,"button",4),b("click",function(){return x(g),v(a.selected=null)}),l(6," Clear selection "),n(),o(7,"section",5)(8,"h4"),l(9,"Form state:"),n(),o(10,"p")(11,"strong"),l(12,"Selected:"),n(),l(13),Z(14,"json"),n(),o(15,"p")(16,"strong"),l(17,"ngModel: "),n(),o(18,"span"),l(19),n(),o(20,"span"),l(21),n(),o(22,"span"),l(23),n()(),o(24,"p")(25,"strong"),l(26,"ngModel.errors: "),n(),o(27,"span"),l(28),Z(29,"json"),n()()()()}if(t&2){let g=X(1);m("items",a.items),Pe("ngModel",a.selected),m("required",a.favoriteRequired)("disabled",a.canSelectFavorite?null:!0),c(3),m("checked",a.canSelectFavorite),c(),m("checked",a.favoriteRequired),c(),m("disabled",a.selected===null),c(8),S(" ",re(14,20,a.selected)," "),c(5),R("state-true",g.valid),c(),S("valid: ",g.valid),c(),R("state-true",g.enabled),c(),S("enabled: ",g.enabled),c(),R("state-true",g.touched),c(),S("touched: ",g.touched),c(4),R("state-true",!g.errors),c(),k(re(29,22,g.errors))}},dependencies:[le,ye,ue,uo,Zt,ge,A,C,Ze],styles:["[_nghost-%COMP%]{display:flex}cookbook-example-configuration-wrapper[_ngcontent-%COMP%]{margin-left:8px}@media (min-width: 768px){cookbook-example-configuration-wrapper[_ngcontent-%COMP%]{margin-left:40px}}.form-state[_ngcontent-%COMP%]{margin-top:12px;border-top:1px solid var(--kirby-medium);padding:8px}.form-state[_ngcontent-%COMP%]   h4[_ngcontent-%COMP%]{margin-bottom:4px;font-weight:400}.form-state[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{margin:0;font-size:12px;line-height:16px}.form-state[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]{background-color:var(--kirby-danger);color:var(--kirby-white);margin-right:4px;padding:0 2px;border-radius:4px}.form-state[_ngcontent-%COMP%]   span.state-true[_ngcontent-%COMP%]{background-color:var(--kirby-success);color:var(--kirby-success-contrast)}"]});let i=e;return i})();var Zm={selector:"cookbook-header-example-default",template:`<kirby-header [title]="'Title'" subtitle1="Subtitle one" subtitle2="Subtitle two">
  ...
  <div class="custom-flag" *kirbyHeaderCustomFlag>
    ...
    align-items: center;
    gap: 6px;
}`]},_S=(()=>{let e=class e{constructor(){this.template=ar.template,this.styles=ar.styles.join(`
...
}`]},$S=(()=>{let e=class e{constructor(){this.template=Di.template,this.styles=Di.styles.join(`
...
</kirby-header>`,styles:Di.styles},iM=(()=>{let e=class e{constructor(r){this.toastController=r,this.template=lr.template,this.styles=lr.styles.join(`
...
</kirby-item>`},nT=(()=>{let e=class e{constructor(){this.template=wd.template}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-label-example-direction"]],decls:15,vars:0,consts:[[1,"kirby-item-title"],[1,"kirby-item-detail"],["direction","horizontal"]],template:function(t,a){t&1&&(o(0,"kirby-item")(1,"kirby-label")(2,"p",0),l(3,"Title"),n(),o(4,"p",1),l(5,"Detail"),n()()(),o(6,"kirby-item")(7,"kirby-label")(8,"kirby-label",2)(9,"p",0),l(10,"Title"),n(),o(11,"p",1),l(12,"Detail"),n()(),o(13,"p"),l(14,"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut non neque vitae felis ultricies imperdiet in ut orci."),n()()())},dependencies:[h,z],styles:["kirby-item[_ngcontent-%COMP%]:not(:last-child){margin-bottom:var(--kirby-spacing-xxs)}"]});let i=e;return i})();export{Md as a,Ld as b,Bd as c,Wd as d,jd as e,Qd as f,Xd as g,ap as h,dp as i,bp as j,kp as k,xp as l,te as m,Pp as n,zp as o,Kp as p,Vp as q,Gp as r,jo as s,Xp as t,nu as u,lu as v,du as w,yu as x,hu as y,vu as z,Su as A,Eu as B,Ou as C,Lu as D,Nu as E,Hu as F,Ru as G,Qu as H,Xu as I,ib as J,ab as K,mb as L,bb as M,fb as N,xb as O,wb as P,Mb as Q,Lb as R,ge as S,Rb as T,jb as U,Qb as V,i0 as W,a0 as X,c0 as Y,u0 as Z,y0 as _,h0 as $,v0 as aa,S0 as ba,E0 as ca,I0 as da,z0 as ea,K0 as fa,V0 as ga,$0 as ha,Y0 as ia,Z0 as ja,og as ka,ag as la,mg as ma,ug as na,yg as oa,Be as pa,xg as qa,Mg as ra,Dg as sa,Ag as ta,Ng as ua,Hg as va,Rg as wa,jg as xa,Qg as ya,ty as za,ny as Aa,dy as Ba,fy as Ca,xy as Da,Sy as Ea,Py as Fa,Fy as Ga,By as Ha,Wy as Ia,$y as Ja,Yy as Ka,nk as La,sk as Ma,bk as Na,fk as Oa,vk as Pa,Ek as Qa,Ik as Ra,Vk as Sa,$k as Ta,Qk as Ua,tf as Va,af as Wa,mf as Xa,bf as Ya,Cf as Za,_f as _a,Mf as $a,Pf as ab,Bf as bb,qf as cb,gn as db,yn as eb,fn as fb,oh as gb,sh as hb,uh as ib,yh as jb,fh as kb,wh as lb,Dh as mb,zh as nb,Bh as ob,Rh as pb,Zh as qb,rC as rb,mC as sb,gC as tb,xC as ub,MC as vb,OC as wb,zC as xb,HC as yb,GC as zb,YC as Ab,xn as Bb,vn as Cb,_n as Db,wn as Eb,Ti as Fb,Mn as Gb,En as Hb,Dn as Ib,On as Jb,In as Kb,Fn as Lb,Ln as Mb,zn as Nb,Bn as Ob,Nn as Pb,qn as Qb,Hn as Rb,_1 as Sb,M1 as Tb,P1 as Ub,A1 as Vb,N1 as Wb,V1 as Xb,Y1 as Yb,Z1 as Zb,t_ as _b,n_ as $b,c_ as ac,b_ as bc,h_ as cc,S_ as dc,O_ as ec,A_ as fc,N_ as gc,R_ as hc,j_ as ic,X_ as jc,rw as kc,sw as lc,dw as mc,gw as nc,hw as oc,_w as pc,Gn as qc,Dw as rc,Lw as sc,Nw as tc,Hw as uc,Rw as vc,jw as wc,Qw as xc,Xw as yc,r2 as zc,s2 as Ac,k2 as Bc,C2 as Cc,_2 as Dc,M2 as Ec,D2 as Fc,A2 as Gc,K2 as Hc,G2 as Ic,eS as Jc,cS as Kc,pS as Lc,gS as Mc,hS as Nc,_S as Oc,MS as Pc,OS as Qc,NS as Rc,VS as Sc,$S as Tc,iM as Uc,sr as Vc,cr as Wc,mr as Xc,dr as Yc,FM as Zc,qM as _c,$M as $c,QM as ad,tT as bd,nT as cd};
