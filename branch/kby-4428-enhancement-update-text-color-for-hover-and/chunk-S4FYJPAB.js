...
}`]},ap=(()=>{let e=class e{constructor(){this.template=Qo.template,this.styles=Qo.styles[0]}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-item-example-slots"]],decls:11,vars:1,consts:[[3,"selectable"],["slot","outside","themeColor","warning","size","sm"],["slot","start","themeColor","light"],["name","person"],[1,"kirby-item-title"],[1,"kirby-item-detail"],["slot","end","themeColor","success"]],template:function(t,a){t&1&&(o(0,"kirby-item",0),p(1,"kirby-badge",1),o(2,"kirby-avatar",2),p(3,"kirby-icon",3),n(),o(4,"kirby-label")(5,"p",4),l(6,"Title"),n(),o(7,"p",5),l(8,"Detail"),n()(),o(9,"kirby-flag",6),l(10,"60"),n()()),t&2&&m("selectable",!0)},dependencies:[C,le,Le,G,w,z],styles:["div[slot=outside][_ngcontent-%COMP%]{display:flex;flex-direction:column}"]});let i=e;return i})();var Mr={selector:"cookbook-item-example-selectable",template:`<kirby-item [selectable]="true">
