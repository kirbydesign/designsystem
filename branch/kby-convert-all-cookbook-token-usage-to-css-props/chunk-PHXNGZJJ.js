import{$a as P,$b as _e,$c as ae,$d as fi,Aa as We,Ad as Q,Ae as me,Ba as D,Bc as Co,Bd as Ht,Be as Si,C as S,Cc as w,Cd as Oo,Ce as Vo,D as M,Da as u,Dc as vo,Dd as pi,Ea as y,Ec as ri,Ed as Fe,Fa as oo,Fd as ui,Fe as Te,Ga as no,Gc as ai,Gd as Xe,Ge as Ro,Ha as It,Hc as h,Hd as bi,He as Go,Ia as Ft,Ic as He,Id as V,Ie as ze,J as pe,Ja as Lt,Jc as ce,Jd as et,Ka as X,Kc as li,Kd as F,Lc as T,Ma as R,Mc as Oe,N as Ji,Na as ro,Nc as Nt,Nd as gi,O as L,Oa as l,Oc as si,Od as yi,Pa as k,Pc as ci,Qa as _,Qc as oe,Ra as ao,Rb as zt,Rd as Io,S as Y,Sb as Bt,Sc as xo,Sd as Le,Tb as ue,Tc as Kt,Td as Wt,Ua as De,Ub as Ce,Ud as be,V as Zi,Va as H,Vb as Zt,Vc as A,Vd as tt,Wa as Pe,Wb as jt,Wd as ki,X as c,Xa as Ee,Xb as Xt,Xd as Fo,Ya as Ai,Yb as ei,Yd as Lo,Zb as ve,Zd as J,_b as xe,_c as Ze,_d as Ao,ab as lo,ad as qt,ae as hi,b as Ut,ba as v,bd as _o,be as Ci,cb as Z,cc as yo,ce as vi,da as d,db as re,dc as ti,dd as mi,de as xi,e as $i,eb as so,ec as qe,ed as N,ee as zo,fb as co,fc as ye,fd as wo,fe as Bo,ga as E,gb as ft,gc as we,gd as di,ge as Vt,h as ji,ha as x,hd as So,he as ee,ic as ii,id as W,ie as _i,j as Li,je as $,k as Yi,ka as Ne,kb as mo,kd as Se,ke as No,la as O,lc as oi,ld as Me,le as Ko,ma as I,me as Rt,na as Qt,nd as G,oa as Xi,od as ht,pa as K,pb as po,pd as Mo,qa as q,qb as At,qd as To,qe as Ae,ra as m,rd as Eo,re as it,s as Ui,sa as o,sb as uo,sc as Ke,sd as z,se as ot,t as Qi,ta as n,tb as Qe,tc as ko,td as ke,te as qo,ua as p,ub as Jt,uc as ni,ud as le,ue as wi,va as se,vb as bo,vc as zi,vd as Do,ve as Ho,wa as ne,wb as Je,wc as U,wd as Ie,we as Wo,xa as eo,xc as fo,xd as C,xe as nt,ya as to,yb as go,yd as B,za as io,zc as ho,zd as Po}from"./chunk-FRLTZ7J4.js";var hr={selector:"cookbook-item-example-sizes",template:`<kirby-item>
...
selected = this.items[2];`},QS=(()=>{let e=class e{constructor(){this.template=ar.template,this.codeSnippet=ar.codeSnippet,this.items=lr,this.selected=this.items[2]}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-radio-in-item-example"]],decls:4,vars:1,consts:[["aria-label","Select main course",3,"value"],["slot","start",3,"value","disabled"]],template:function(t,a){t&1&&(o(0,"kirby-card")(1,"kirby-radio-group",0),K(2,ad,3,3,"kirby-item",null,rd),n()()),t&2&&(c(),m("value",a.selected),c(),q(a.items))},dependencies:[T,le,C,ke],encapsulation:2});let i=e;return i})();var cr=["Bacon","Salami","Tenderloin","Tongue","Drumstick"],sr={selector:"cookbook-radio-reactive-forms-example",template:`<form [formGroup]="form">
...
favoriteRequired = true;`},b2=(()=>{let e=class e{constructor(){this.template=mr.template.split("<cookbook-example-configuration-wrapper>")[0],this.codeSnippet=mr.codeSnippet,this.items=dr,this.selected=null,this.canSelectFavorite=!0,this.favoriteRequired=!0}};e.\u0275fac=function(t){return new(t||e)},e.\u0275cmp=d({type:e,selectors:[["cookbook-radio-template-driven-forms-example"]],decls:30,vars:24,consts:[["group","ngModel"],[3,"ngModelChange","items","ngModel","required","disabled"],["text","Form field enabled","size","xs",3,"checkedChange","checked"],["text","Form field required","size","xs",3,"checkedChange","checked"],["kirby-button","","size","sm","attentionLevel","2",3,"click","disabled"],[1,"form-state"]],template:function(t,a){if(t&1){let g=D();o(0,"kirby-radio-group",1,0),Pe("ngModelChange",function(yt){return S(g),H(a.selected,yt)||(a.selected=yt),M(yt)}),n(),o(2,"cookbook-example-configuration-wrapper")(3,"kirby-checkbox",2),u("checkedChange",function(){return a.canSelectFavorite=!a.canSelectFavorite}),n(),o(4,"kirby-checkbox",3),u("checkedChange",function(){return a.favoriteRequired=!a.favoriteRequired}),n(),o(5,"button",4),u("click",function(){return a.selected=null}),l(6," Clear selection "),n(),o(7,"section",5)(8,"h4"),l(9,"Form state:"),n(),o(10,"p")(11,"strong"),l(12,"Selected:"),n(),l(13),Z(14,"json"),n(),o(15,"p")(16,"strong"),l(17,"ngModel: "),n(),o(18,"span"),l(19),n(),o(20,"span"),l(21),n(),o(22,"span"),l(23),n()(),o(24,"p")(25,"strong"),l(26,"ngModel.errors: "),n(),o(27,"span"),l(28),Z(29,"json"),n()()()()}if(t&2){let g=X(1);m("items",a.items),De("ngModel",a.selected),m("required",a.favoriteRequired)("disabled",a.canSelectFavorite?null:!0),c(3),m("checked",a.canSelectFavorite),c(),m("checked",a.favoriteRequired),c(),m("disabled",a.selected===null),c(8),_(" ",re(14,20,a.selected)," "),c(5),R("state-true",g.valid),c(),_("valid: ",g.valid),c(),R("state-true",g.enabled),c(),_("enabled: ",g.enabled),c(),R("state-true",g.touched),c(),_("touched: ",g.touched),c(4),R("state-true",!g.errors),c(),k(re(29,22,g.errors))}},dependencies:[le,ye,ue,yo,ei,ge,z,h,Qe],styles:["[_nghost-%COMP%]{display:flex}cookbook-example-configuration-wrapper[_ngcontent-%COMP%]{margin-left:var(--kirby-spacing-xxs)}@media(min-width:768px){cookbook-example-configuration-wrapper[_ngcontent-%COMP%]{margin-left:var(--kirby-spacing-xl)}}.form-state[_ngcontent-%COMP%]{margin-top:var(--kirby-spacing-xs);border-top:1px solid var(--kirby-medium);padding:var(--kirby-spacing-xxs)}.form-state[_ngcontent-%COMP%]   h4[_ngcontent-%COMP%]{margin-bottom:var(--kirby-spacing-xxxs);font-weight:var(--kirby-font-weight-normal)}.form-state[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{margin:0;font-size:var(--kirby-font-size-xs);line-height:var(--kirby-line-height-xs)}.form-state[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]{background-color:var(--kirby-danger);color:var(--kirby-white);margin-right:var(--kirby-spacing-xxxs);padding:0 var(--kirby-spacing-xxxxs);border-radius:var(--kirby-spacing-xxxs)}.form-state[_ngcontent-%COMP%]   span.state-true[_ngcontent-%COMP%]{background-color:var(--kirby-success);color:var(--kirby-success-contrast)}"]});let i=e;return i})();var ld={selector:"cookbook-header-example-default",template:`<kirby-header [title]="'Title'" subtitle1="Subtitle one" subtitle2="Subtitle two">
  ...
  <div class="custom-flag" *kirbyHeaderCustomFlag>
    ...
    align-items: center;
    gap: 6px;
}`]},E2=(()=>{let e=class e{constructor(){this.template=pr.template,this.styles=pr.styles.join(`
...
}`]},J2=(()=>{let e=class e{constructor(){this.template=Fi.template,this.styles=Fi.styles.join(`
