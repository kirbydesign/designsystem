...
To enable the polyfill, you register a _ponyfill_ that checks whether the polyfill is needed or the feature is already supported by the browser.  
...
<head>
  ...
  <script src="kirby/polyfills/resize-observer-ponyfill.min.js"></script>
</head>
```
_**Please note:** If you don't want the additional http request for the ponyfill,  you can copy the contents of `node_modules/@kirbydesign/designsystem/polyfills/resize-observer-ponyfill.js` into a `script` tag in `index.html` instead_
